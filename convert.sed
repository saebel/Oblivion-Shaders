...
s/dp2add \([][a-zINOUT0-9_\.]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.]\+\)/\1 = dot(\2.xy, \3.xy) + \4;/g
s/dp3 \([][a-zINOUT0-9_\.]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.\-]\+\)/\1 = dot(\2.xyz, \3.xyz);/g
s/dp4 \([][a-zINOUT0-9_\.]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.\-]\+\)/\1 = dot(\2.xyzw, \3.xyzw);/g
...
# r0.xyz = r0
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = \([][a-zINOUT0-9_\-]\+\);/\1.\2 = \3.\2;/g
# r0.xyz = r0 * r0.w
# r0.xyz = r0 + r0.w
# r0.xyz = r0 - r0.w
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = \([][a-zINOUT0-9_\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\);/\1.\2 = \3.\2 \4 \5.\2;/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = \([][a-zINOUT0-9_\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\.\-]\+\);/\1.\2 = \3.\2 \4 \5;/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = \([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\);/\1.\2 = \3 \4 \5.\2;/g
# r0.xy = (r1.w * WindData) + r3;
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = (\([][a-zINOUT0-9_\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\)) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\);/\1.\2 = (\3.\2 \4 \5.\2) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\)) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\);/\1.\2 = (\3 \4 \5.\2) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\.\-]\+\)) \([\*\+\-]\) \([][a-zINOUT0-9_\-]\+\);/\1.\2 = (\3 \4 \5) \6 \7.\2;/g
# r0.xyz = max(r0, 1)
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = max(\([][a-zINOUT0-9_\-]\+\), \([][a-zINOUT0-9_\-]\+\));/\1.\2 = max(\3.\2, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = min(\([][a-zINOUT0-9_\-]\+\), \([][a-zINOUT0-9_\-]\+\));/\1.\2 = min(\3.\2, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = max(\([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\-]\+\));/\1.\2 = max(\3, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = min(\([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\-]\+\));/\1.\2 = min(\3, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = max(\([][a-zINOUT0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = max(\3.\2, \4);/g
s/\([][a-zINOUT0-9_]\+\).\([xyzw]\+\) = min(\([][a-zINOUT0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = min(\3.\2, \4);/g
# r0 = ...
s/^\([ INOUT\.]*\)\([][a-zINOUT0-9_]\+\) = \([][a-zINOUT0-9_\-]\+\);/\1\2.xyzw = \3.xyzw;/g
