...
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = (\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \(.*\) [?] \(.*\) [:] \(.*\));/\1.\2 = (\3.\4 \6 ? \7 : \8);/g

# r3.xyz = (r5.yzxw * r0.zxyw) - r3.xyz;
# r1.yz = (r0.xzyw * const_8.xzww) - r3.yz;
# r2.xy = (fVars1.z * r4.zwzw) + r4.wz;
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = (\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \(.*\))\(.*\);/\1.\2 = (\3.\4 \6 \7)\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = (\(.*\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\))\(.*\);/\1.\2 = (\3 \4 \5.\6)\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = (\(.*\) \([\*\+\-]\) \(.*\))\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = (\3 \4 \5)\7.\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw][xyzw]\) = (\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \(.*\))\(.*\);/\1.\2 = (\3.\4 \6 \7)\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw][xyzw]\) = (\(.*\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\))\(.*\);/\1.\2 = (\3 \4 \5.\6)\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw][xyzw]\) = (\(.*\) \([\*\+\-]\) \(.*\))\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = (\3 \4 \5)\7.\8;/g
# r3.xyz = r0.yzxw * r5.zxyw;
# r4.xy = r1.ywzw * r1.xzzw;
# r1.xz = -r0.xyyw * r0.w;
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3 \5 \6.\7;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = \3.\4 \6 \7.\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw]\);/\1.\2 = \3.\4 \6 \7.\8;/g
# r2.xyz = r13.x + const_18.zxyw;
# r5.yz = r5.x + const_4.xxyw;
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3 \4 \5.\6;/g
s/\([][a-zINOUT0-9_]\+\)\.yz = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.yz = \2.\3 \4 \5.\6;/g
# r3.yz = r0.x * const_13.xzww;
# r2.xy = r2.w - AlphaParam.xzzw;
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = \3.\4 \5 \6.\7;/g
# r9.xyz = (2 * r3.w) + const_8.yzww;
# r3.xy = (2 * r5.w) + const_17.yzzw;
s/\([][a-zINOUT0-9_]\+\)\.xyz = (\(.*\)) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = (\2) \3 \4.\5;/g
s/\([][a-zINOUT0-9_]\+\)\.xy = (\(.*\)) \([\*\+\-]\) \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.xy = (\2) \3 \4.\5;/g
# r2.xyz = r2.wyzw;			// partial precision
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3;/g
# r6.x = dot(r1.wxzw, r3.xyz);
s/\([][a-zINOUT0-9_\.]\+\) = dot(\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\), \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\));/\1 = dot(\2.\3, \4.\5);/g
s/\([][a-zINOUT0-9_\.]\+\) = dot(\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\), \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\));/\1 = dot(\2.\3, \5.\6);/g
# r5.xy = lerp(fVars1.yzzw, r1.xzzw, r3.y);
s/\([][a-zINOUT0-9_\.]\+\)\.\([xyzw][xyzw]\) = lerp(\(.*\), \([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\), \(.*\));/\1.\2 = lerp(\3, \4.\5, \7);/g
s/\([][a-zINOUT0-9_\.]\+\)\.\([xyzw][xyzw]\) = lerp(\([INOUT.]*[][a-zV0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\), \(.*\), \(.*\));/\1.\2 = lerp(\3.\4, \6, \7);/g
