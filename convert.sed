...
s/\([INOUT.]*[][a-z0-9_]\+\)\.\([xyzw]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = \3.\2;/g
s/^\([ INOUT\.]*\)\([][a-zINOUT0-9_]\+\) = \(.*\);/\1\2.xyzw = \3;/g
s/^\([ INOUT\.]*\)\([][a-zINOUT0-9_]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\);/\1\2.xyzw = \3.xyzw;/g
# r0.xyz = r0
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = \3.\2;/g
# r0.xyz = r0 * r0.w
# r0.xyz = r0 + r0.w
# r0.xyz = r0 - r0.w
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = \3.\2 \4 \5.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\.\-]\+\);/\1.\2 = \3.\2 \4 \5;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = \3 \4 \5.\2;/g
# r0.xyz = (r0 * r1) + r2
# r0.xy = (r1.w * WindData) + r3;
# r0.xyz = (r0.w * AmbientColor) + r0.z;			// partial precision
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = (\3.\2 \4 \5.\2) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = (\3.\2 \4 \5.\2) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = (\3 \4 \5.\2) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\.\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = (\3 \4 \5) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\.\-]\+\);/\1.\2 = (\3 \4 \5.\2) \6 \7;/g
# r0.xyz = (-0.5 * abs(r2)) + r5;
# r3.xyz = MaxPos - abs(r3.xyz);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) abs(\([INOUT.]*[][a-z0-9_\-]\+\))) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = (\3 \4 abs(\5.\2)) \6 \7.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \(.*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\);/\1.\2 = \3 \4 \5.\2;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \(.*\);/\1.\2 = \3.\2 \4 \5;/g
# r0.xyz = max(r0, 1)
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = max(\([INOUT.]*[][a-z0-9_\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = max(\3.\2, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = min(\([INOUT.]*[][a-z0-9_\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = min(\3.\2, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = max(\([][a-zINOUT0-9_\.\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = max(\3, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = min(\([][a-zINOUT0-9_\.\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = min(\3, \4.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = max(\([INOUT.]*[][a-z0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = max(\3.\2, \4);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = min(\([INOUT.]*[][a-z0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = min(\3.\2, \4);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = normalize(\([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = normalize(\3.\2);/g
# r0.xyzw = frac(r0);
# r0.xyzw = abs(r0) + r5;
# r0.xyzw = frac(abs(r0)) + r5;
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([a-z]\+\)(\([INOUT.]*[][a-z0-9_\-]\+\))\(.*\);/\1.\2 = \3(\4.\2)\5;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \([a-z]\+\)(\([a-z]\+\)(\([INOUT.]*[][a-z0-9_\-]\+\)))\(.*\);/\1.\2 = \3(\4(\5.\2))\6;/g
# r3.xyz = MaxPos - abs(r3);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \(.*\) \([a-z]\+\)(\([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = \3 \4(\5.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = \(.*\) \([a-z]\+\)(\([a-z]\+\)(\([INOUT.]*[][a-z0-9_\-]\+\)));/\1.\2 = \3 \4(\5(\6.\2));/g
# r4.xy = saturate(r0 + const_9);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate(\([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = saturate(\3.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate(\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = saturate(\3.\2 \4 \5.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate(\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = saturate(\3.\2 \4 \5);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate(\([][a-zINOUT0-9_\.\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = saturate(\3 \4 \5.\2);/g
# r2.xy = saturate((r1 * r10) + const_11);
# r0.xy = saturate((r0.w * 0.01) + r0);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate((\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = saturate((\3.\2 \4 \5.\2) \6 \7.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate((\([INOUT.]*[][a-z0-9_\-]\+\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)) \([\*\+\-]\) \(.*\));/\1.\2 = saturate((\3.\2 \4 \5.\2) \6 \7);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = saturate((\(.*\) \([\*\+\-]\) \(.*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = saturate((\3 \4 \5) \6 \7.\2);/g
# r0.xyzw = lerp(const_1, r1, r2.w);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = lerp(\([INOUT.]*[][a-z0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = lerp(\3.\2, \4, \5);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = lerp(\([][a-zINOUT0-9_\.\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\), \([][a-zINOUT0-9_\.\-]\+\));/\1.\2 = lerp(\3, \4.\2, \5);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = lerp(\([][a-zINOUT0-9_\.\-]\+\), \([][a-zINOUT0-9_\.\-]\+\), \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = lerp(\3, \4, \5.\2);/g
# r1.xyzw = (r7.y <= 0.0 ? r1 : LightData[2]);
# r3.xyz = (r1 == 0 ? 1.0 : 0.0);
# r0.xyz = (0 < r0 ? 1.0 : 0.0);
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\(.*\) [?] \([INOUT.]*[][a-z0-9_\-]\+\) [:] \(.*\));/\1.\2 = (\3 ? \4.\2 : \5);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\(.*\) [?] \(.*\) [:] \([INOUT.]*[][a-z0-9_\-]\+\));/\1.\2 = (\3 ? \4 : \5.\2);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\([INOUT.]*[][a-z]\+[a-z0-9_\-]*\) \(.*\) [?] \(.*\) [:] \(.*\));/\1.\2 = (\3.\2 \4 ? \5 : \6);/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw]\+\) = (\(.*\) \([INOUT.]*[][a-z]\+[a-z0-9_\-]*\) [?] \(.*\) [:] \(.*\));/\1.\2 = (\3 \4.\2 ? \5 : \6);/g
...
# r1.xz = -r0.xyyw * r0.w;
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3 \5 \6.\7;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = \3.\4 \6 \7.\8;/g
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw]\);/\1.\2 = \3.\4 \6 \7.\8;/g
# r2.xyz = r13.x + const_18.zxyw;
# r5.yz = r5.x + const_4.xxyw;
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3 \4 \5.\6;/g
s/\([][a-zINOUT0-9_]\+\)\.yz = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.yz = \2.\3 \4 \5.\6;/g
# r3.yz = r0.x * const_13.xzww;
# r2.xy = r2.w - AlphaParam.xzzw;
s/\([][a-zINOUT0-9_]\+\)\.\([xyzw][xyzw]\) = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw]\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.\2 = \3.\4 \5 \6.\7;/g
# r3.xyz = (r5.yzxw * r0.zxyw) - r3.xyz;
# r1.yz = (r0.xzyw * const_8.xzww) - r3.yz;
s/\([][a-zINOUT0-9_]\+\)\.xyz = (\([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\))\(.*\);/\1.xyz = (\2.\3 \5 \6.\7)\9;/g
s/\([][a-zINOUT0-9_]\+\)\.xy = (\([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\))\(.*\);/\1.xy = (\2.\3 \5 \6.\7)\9;/g
s/\([][a-zINOUT0-9_]\+\)\.yz = (\([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\))\(.*\);/\1.yz = (\2.\3 \5 \6.\7)\9;/g
# r9.xyz = (2 * r3.w) + const_8.yzww;
# r3.xy = (2 * r5.w) + const_17.yzzw;
s/\([][a-zINOUT0-9_]\+\)\.xyz = (\(.*\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = (\2) \3 \4.\5;/g
s/\([][a-zINOUT0-9_]\+\)\.xy = (\(.*\)) \([\*\+\-]\) \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw]\)\([xyzw]*\);/\1.xy = (\2) \3 \4.\5;/g
# r2.xyz = r2.wyzw;			// partial precision
s/\([][a-zINOUT0-9_]\+\)\.xyz = \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\);/\1.xyz = \2.\3;/g
# r6.x = dot(r1.wxzw, r3.xyz);
s/\([][a-zINOUT0-9_\.]\+\) = dot(\([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\), \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\));/\1 = dot(\2.\3, \4.\5);/g
s/\([][a-zINOUT0-9_\.]\+\) = dot(\([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\)\([xyzw]*\), \([INOUT.]*[][a-z0-9_\-]\+\)\.\([xyzw][xyzw][xyzw]\));/\1 = dot(\2.\3, \5.\6);/g
