...
//
    ...
    const_7 = {-0.5, 0, 1, 0.5};
    const_8 = {2, -6, -7, 0};
    EyePosition7 = {0.300000012, 0.200000003, 3, 0};
    EyePosition8 = {-1, -2, 0, 2};
    EyePosition9 = {-2, -3, -4, 0};
    HairTint0 = {-4, -5, -6, 0};
    ...
    if_ne r4.w, -r4.w
      ...
      r1.xyz = (input_1.y * r1) - const_7.w;			// partial precision
      r0.w = r3.w * const_4.z;			// partial precision
      r1.xyz = r1 - r1;			// partial precision
      r2.z = (r3.z >= const_7.y ? r3.z : const_7.y);			// partial precision
    ...
    r13.x = r0.w - r0.w;
    r13.yz = r13.x - EyePosition8.xxyw;
    r2.xyz = r13.x - EyePosition8.zxyw;
    ...
    if_ne r5.w, -r5.w
      ...
      r3.xyz = (input_1.y * r3) - const_7.w;			// partial precision
      r2.xyz = (r2.z == 0.0 ? LightData[2] : r13)			// partial precision
      r13.xyz = (EyePosition7.x * r3) + EyePosition7.y;			// partial precision
    ...
    if_lt EyePosition7.z, r4.w
      ...
      r2.xyz = (input_1.y * r2) - const_7.w;			// partial precision
      r0.xyz = (r3.y == 0.0 ? LightData[7] : r0)			// partial precision
      r5.xyz = (EyePosition7.x * r2) + EyePosition7.y;			// partial precision
    ...
    r0.xyz = (input_1.y * r0) - const_7.w;			// partial precision
