...
//
    ...
    r1.w = 1.0 / r1.w;
    r1.z = 0;
    r2.x = dot(r1.wxz, IN.normal.xyz);
    r1.y = -r1.w;
    r2.xyz = r5.xyz * r2.x;
    r3.x = dot(r1.xyz, IN.normal.xyz);
    r3.xyz = (r3.x * r4.xyz) + r2.xyz;
    r2.xyz = r2.w * IN.color_0.rgb;
    r3.xyz = (IN.normal.z * r0.xyz) + r3.xyz;
    r6.x = WindData.w;
    r2.w = (r0.w * (1.0 / 128)) + r6.x;
    r3.x = dot(DiffuseDir.xyz, r3.xyz);
    r0.w = max(r3.x, 0);
    r3.yz = const_8.yz;
    r3.w = r3.y * InstanceData[0 + offset.w].w;
    r0.w = min(r0.w, 1);
    r3.xyz = (r3.w * ScaleMask.xyz) + r3.z;
