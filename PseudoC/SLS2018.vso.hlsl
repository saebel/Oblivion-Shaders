...
//
    ...
    r4.xyz = norm(r3);
    r1.xyz = (r1.w * r1) + r2;
    r6.x = (r4.x * LightDirection[0].x) + (r4.y * LightDirection[0].y) + (r4.z * LightDirection[0].z);
    r3.xyz = norm(r1);
    r6.y = (r3.x * LightDirection[0].x) + (r3.y * LightDirection[0].y) + (r3.z * LightDirection[0].z);
    ...
    r1.xyz = norm(r2);
    r2.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r6.z = (r1.x * LightDirection[0].x) + (r1.y * LightDirection[0].y) + (r1.z * LightDirection[0].z);
    r1.w = 1.0 / sqrt(r2.x);
    r2.x = (r6.x * r6.x) + (r6.y * r6.y) + (r6.z * r6.z);
    r7.xyz = (r1.w * r5) + LightDirection[0];
    r2.w = 1.0 / sqrt(r2.x);
    r2.xyz = norm(r7);
    texcoord_1.xyz = r6 * r2.w;
    r7.x = (r4.x * r2.x) + (r4.y * r2.y) + (r4.z * r2.z);
    r7.y = (r3.x * r2.x) + (r3.y * r2.y) + (r3.z * r2.z);
    r7.z = (r1.x * r2.x) + (r1.y * r2.y) + (r1.z * r2.z);
    r6.x = (r7.x * r7.x) + (r7.y * r7.y) + (r7.z * r7.z);
    r2.xyz = SkinModelViewProj[0]7 - r0;
    r2.w = 1.0 / sqrt(r6.x);
    r6.xyz = norm(r2);
    texcoord_3.xyz = r7 * r2.w;
    texcoord_2.x = (r4.x * r6.x) + (r4.y * r6.y) + (r4.z * r6.z);
    texcoord_2.y = (r3.x * r6.x) + (r3.y * r6.y) + (r3.z * r6.z);
    texcoord_2.z = (r1.x * r6.x) + (r1.y * r6.y) + (r1.z * r6.z);
    r6.xyz = (r1.w * r5) + r6;
    r1.w = 1.0 / SkinModelViewProj[0]7.w;
    r5.xyz = r2 * r1.w;
    r2.xyz = norm(r6);
    texcoord_5.xyz = (const_0.w * r5) + const_0.w;
    texcoord_4.x = (r4.x * r2.x) + (r4.y * r2.y) + (r4.z * r2.z);
    texcoord_4.y = (r3.x * r2.x) + (r3.y * r2.y) + (r3.z * r2.z);
    r4.x = (ShadowProj[0].x * r0.x) + (ShadowProj[0].y * r0.y) + (ShadowProj[0].z * r0.z) + (ShadowProj[0].w * r0.w);
    r4.y = (ShadowProj[1].x * r0.x) + (ShadowProj[1].y * r0.y) + (ShadowProj[1].z * r0.z) + (ShadowProj[1].w * r0.w);
    r1.w = (ShadowProj[3].x * r0.x) + (ShadowProj[3].y * r0.y) + (ShadowProj[3].z * r0.z) + (ShadowProj[3].w * r0.w);
    texcoord_4.z = (r1.x * r2.x) + (r1.y * r2.y) + (r1.z * r2.z);
