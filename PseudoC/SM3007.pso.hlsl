...
//
    ...
    if_ne r0.w, -r0.w
      r0.x = (r6.x * LightData[01].x) + (r6.y * LightData[01].y) + (r6.z * LightData[01].z);			// partial precision
      r2.w = (r1.x * r5.x) + (r1.y * r5.y) + (r1.z * r5.z);			// partial precision
      r0.y = (r7.x * LightData[01].x) + (r7.y * LightData[01].y) + (r7.z * LightData[01].z);			// partial precision
      r0.w = (r2.w >= const_2.y ? r2.w : const_2.y);			// partial precision
      r0.z = (r2.x * LightData[01].x) + (r2.y * LightData[01].y) + (r2.z * LightData[01].z);			// partial precision
      ...
      r4.xyz = r0 * LightData[00];			// partial precision
      r2.w = const_2.z;
      r3.xyz = r0.w * LightData[00];			// partial precision
    else
      r0.w = const_2.y;
    ...
    r3.w = const_4.x - r0.w;			// partial precision
    ...
    if_ne r0.w, -r0.w
      ...
      r9.xyz = (r0 >= 0.0 ? -r8 : r0);
      r0 = (r9.x <= 0.0 ? r11.y : LightData[01]);
      r0 = (r9.y <= 0.0 ? r0 : LightData[02]);
    ...
    if_lt const_2.z, r3.w
      ...
      r0 = (r9.x == 0.0 ? LightData[03] : r11.y)
      r0 = (r9.y == 0.0 ? LightData[04] : r0)
    ...
    if_lt -const_4.z, r3.w
      ...
      r0 = (r9.x == 0.0 ? LightData[05] : r11.y)
      r0 = (r9.y == 0.0 ? LightData[06] : r0)
    ...
    if_lt -const_7.z, r3.w
      ...
      r0 = (r9.x == 0.0 ? LightData[07] : r11.y)
      r0 = (r9.y == 0.0 ? LightData[08] : r0)
    ...
    if_lt -const_7.w, r3.w
      ...
      r0 = (r9.x == 0.0 ? LightData[09] : r11.y)
