...
//
    ...
    r1.x = 2 * r2.w;
    r4.xyz = (r1.w * ScaleMask.xyz) + r1.z;
    r1.w = 1.0 - (r1.x * r1.x);
    r6.xyz = r4.xyz * IN.position.xyz;
    r1.w = 1.0 / sqrt(r1.w);
    r1.w = 1.0 / r1.w;
    r1.z = 0;
    r4.xyz = (r5.yzx * r0.zxy) - r2.xyz;
    r2.x = dot(r1.wxz, r6.xyz);
    r7.x = WindData.w;
    r0.w = (r0.w * (1.0 / 128)) + r7.x;
    r2.xyz = r5.xyz * r2.x;
    r1.y = -r1.w;
    r0.w = (r0.w * (1.0 / (PI * 2))) + 0.5;
    r8.x = dot(r1.wxz, IN.normal.xyz);
    r0.w = frac(r0.w);
