...
//
    ...
    if_lt 7, r2.w
      ...
      r1.xyzw = (r9.x == 0.0 ? LightData[15].xyzw : r11.y);
      r1.xyzw = (r9.y == 0.0 ? LightData[16].xyzw : r1.xyzw);
      r1.xyzw = (r9.z == 0.0 ? LightData[17].xyzw : r1.xyzw);
      r10.xyz = (r9.x == 0.0 ? LightData[14].xyz : r11.y);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
      r1.xyz = (r9.y == 0.0 ? LightData[15].xyz : r10.xyz);			// partial precision
      r10.x = dot(r8.xyz, r4.xyz);
      r10.y = dot(r7.xyz, r4.xyz);
      r10.z = dot(r6.xyz, r4.xyz);
      r1.xyz = (r9.z == 0.0 ? LightData[16].xyz : r1.xyz);			// partial precision
      r9.xyz = normalize(r10.xyz);			// partial precision
      r4.w = dot(r4.xyz, r4.xyz);	// normalize + length
      r10.xyz = r5.xyz + r9.xyz;			// partial precision
      r4.w = 1.0 / sqrt(r4.w);
    ...
    if_lt 8, r2.w
      ...
      r1.xyzw = (r9.x == 0.0 ? LightData[17].xyzw : r11.y);
      r1.xyzw = (r9.y == 0.0 ? LightData[18].xyzw : r1.xyzw);
      r1.xyzw = (r9.z == 0.0 ? LightData[19].xyzw : r1.xyzw);
      r10.xyz = (r9.x == 0.0 ? LightData[16].xyz : r11.y);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
      r1.xyz = (r9.y == 0.0 ? LightData[17].xyz : r10.xyz);			// partial precision
      r10.x = dot(r8.xyz, r4.xyz);
      r10.y = dot(r7.xyz, r4.xyz);
      r10.z = dot(r6.xyz, r4.xyz);
      r1.xyz = (r9.z == 0.0 ? LightData[18].xyz : r1.xyz);			// partial precision
      r9.xyz = normalize(r10.xyz);			// partial precision
      r4.w = dot(r4.xyz, r4.xyz);	// normalize + length
      r10.xyz = r5.xyz + r9.xyz;			// partial precision
      r4.w = 1.0 / sqrt(r4.w);
    ...
    if_lt 9, r2.w
      r4.xyz = LightData[19].xyz - IN.texcoord_6.xyz;
      ...
      r1.xyz = (r5.x == 0.0 ? LightData[18].xyz : r11.y);			// partial precision
      r3.w = dot(r3.xyz, r4.xyz);			// partial precision
      r1.xyz = (r5.y == 0.0 ? LightData[19].xyz : r1.xyz);			// partial precision
      r3.w = r2.w * r3.w;			// partial precision
      r3.xyz = r1.w * r1.xyz;			// partial precision
      r1.w = max(r3.w, 0);			// partial precision
