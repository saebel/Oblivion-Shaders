...
//
    ...
    r0.x = (const_42.x * r0.x) + (const_42.y * r0.y) + (const_42.z * r0.z);
    r2.x = (input_1.x * const_42.x) + (input_1.y * const_42.y) + (input_1.z * const_42.z);
    texcoord_0.xy = (const_4.x * r1) + const_4.y;
    r1.w = (r2.x >= const_4.z ? r2.x : const_4.z);
    abs r0.w, r0.x
    r2.w = const_4.w - r1.w;
    ...
    r0.y = const_45.w;
    r0.z = const_46.w;
    texcoord_0.z = r1.w * r0.w;
    r0.xyz = r0 - input_0;
    r1.x = (const_44.x * r0.x) + (const_44.y * r0.y) + (const_44.z * r0.z);
    r1.y = (const_45.x * r0.x) + (const_45.y * r0.y) + (const_45.z * r0.z);
    r0.x = (const_46.x * r0.x) + (const_46.y * r0.y) + (const_46.z * r0.z);
    r2.x = (input_1.x * const_46.x) + (input_1.y * const_46.y) + (input_1.z * const_46.z);
    ...
    r0.x = (const_50.x * r0.x) + (const_50.y * r0.y) + (const_50.z * r0.z);
    r2.x = (input_1.x * const_50.x) + (input_1.y * const_50.y) + (input_1.z * const_50.z);
    ...
    r0.x = (const_54.x * r0.x) + (const_54.y * r0.y) + (const_54.z * r0.z);
    r2.x = (input_1.x * const_54.x) + (input_1.y * const_54.y) + (input_1.z * const_54.z);
    ...
    r0.x = (const_58.x * r0.x) + (const_58.y * r0.y) + (const_58.z * r0.z);
    r2.x = (input_1.x * const_58.x) + (input_1.y * const_58.y) + (input_1.z * const_58.z);
    ...
    r0.x = (const_62.x * r0.x) + (const_62.y * r0.y) + (const_62.z * r0.z);
    r2.x = (input_1.x * const_62.x) + (input_1.y * const_62.y) + (input_1.z * const_62.z);
    ...
    r0.x = (const_66.x * r0.x) + (const_66.y * r0.y) + (const_66.z * r0.z);
    r2.x = (input_1.x * const_66.x) + (input_1.y * const_66.y) + (input_1.z * const_66.z);
    ...
    r2.x = (input_1.x * const_70.x) + (input_1.y * const_70.y) + (input_1.z * const_70.z);
