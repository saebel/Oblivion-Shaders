...
//
    ...
    r0.x = dot(DecalProjection[2].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[2].xyz);
    ...
    r0.x = dot(DecalProjection[6].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[6].xyz);
    ...
    r0.x = dot(DecalProjection[10].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[10].xyz);
    ...
    r0.x = dot(DecalProjection[14].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[14].xyz);
    ...
    r0.x = dot(DecalProjection[18].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[18].xyz);
    ...
    r0.x = dot(DecalProjection[22].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[22].xyz);
    ...
    r0.x = dot(DecalProjection[26].xyz, r0.xyz);
    r2.x = dot(IN.normal.xyz, DecalProjection[26].xyz);
