...
//
    ...
    r2.x = dot(DecalProjection[1][2].xyz, r0.xyz);
    OUT.texcoord_1.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[1][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(DecalProjection[2][2].xyz, r0.xyz);
    OUT.texcoord_2.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[2][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(DecalProjection[3][2].xyz, r0.xyz);
    OUT.texcoord_3.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[3][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(DecalProjection[4][2].xyz, r0.xyz);
    OUT.texcoord_4.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[4][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(DecalProjection[5][2].xyz, r0.xyz);
    OUT.texcoord_5.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[5][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(DecalProjection[6][2].xyz, r0.xyz);
    OUT.texcoord_6.xy = (0.0125000002 * r1.xy) + 0.5;
    r0.x = dot(IN.normal.xyz, DecalProjection[6][2].xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
