...
//
    ...
    r2.x = dot(const_46.xyz, r0.xyz);
    OUT.texcoord_1.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_46.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(const_50.xyz, r0.xyz);
    OUT.texcoord_2.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_50.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(const_54.xyz, r0.xyz);
    OUT.texcoord_3.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_54.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(const_58.xyz, r0.xyz);
    OUT.texcoord_4.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_58.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(const_62.xyz, r0.xyz);
    OUT.texcoord_5.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_62.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
    ...
    r2.x = dot(const_66.xyz, r0.xyz);
    OUT.texcoord_6.xy = (0.0125000002 * r1) + 0.5;
    r0.x = dot(IN.normal.xyz, const_66.xyz);
    r1.w = abs(r2.x);
    r0.w = max(r0.x, 0);
    r1.w = (r1.w * -(1.0 / 256)) + 1;
    r2.w = 1 - r0.w;
