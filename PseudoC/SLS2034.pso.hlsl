...
//
    ...
    r7.xyzw = tex2D(ShadowMaskMap, r2.xy);			// partial precision
    r8.xyzw = tex2D(ShadowMap, IN.texcoord_6.xy);			// partial precision
    ...
    r0.xyz = r8.xyz - 1;			// partial precision
    r7.xyz = (r7.x * r0.xyz) + 1;			// partial precision
    r8.xyz = normalize(IN.texcoord_2.xyz);			// partial precision
    r0.xyz = r6.xyz - 0.5;
    r6.xyz = 2 * r0.xyz;			// partial precision
    r0.xyz = normalize(r6.xyz);			// partial precision
    r1.w = 1 - r5.x;			// partial precision
    r5.x = saturate(dot(r0.xyz, r8.xyz));			// partial precision
    r1.w = saturate(r1.w - r4.x);			// partial precision
    r4.xyz = r5.x * PSLightColor[1].rgb;			// partial precision
    r5.xyz = r1.w * r4.xyz;			// partial precision
    r4.x = saturate(dot(r0.xyz, IN.texcoord_1.xyz));			// partial precision
    r4.xyz = r4.x * PSLightColor[0].rgb;			// partial precision
    r4.xyz = (r7.xyz * r4.xyz) + r5.xyz;			// partial precision
    r5.xyz = normalize(IN.texcoord_3.xyz);			// partial precision
    r1.w = 1 - r3.x;			// partial precision
    r0.x = saturate(dot(r0.xyz, r5.xyz));			// partial precision
    r1.w = saturate(r1.w - r2.x);			// partial precision
    r0.xyz = r0.x * PSLightColor[2].rgb;			// partial precision
    r2.xyz = (r1.w * r0.xyz) + r4.xyz;			// partial precision
    r0.xyz = EmittanceColor.rgb;
    r0.xyz = (r1.xyz * r0.xyz) + AmbientColor.rgb;			// partial precision
