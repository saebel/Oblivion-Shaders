...
//
    ...
    r2.x = (input_3.x * const_0.x.x) + (input_3.y * const_0.x.y) + (input_3.z * const_0.x.z);
    ...
    color_0 = (input_2.xyzx * const_0.xxxz) - const_0.zzzx;
