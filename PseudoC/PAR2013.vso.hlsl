...
//
    ...
    r2.w = 1.0 / sqrt(r7.x);
    r2.xyz = norm(r1);
    r1.xyz = (r2.w * r5) + LightDirection;
    r6.z = (r2.x * LightDirection.x) + (r2.y * LightDirection.y) + (r2.z * LightDirection.z);
    r7.xyz = norm(r1);
    r1.x = (r4.x * r7.x) + (r4.y * r7.y) + (r4.z * r7.z);
    r1.y = (r3.x * r7.x) + (r3.y * r7.y) + (r3.z * r7.z);
    r1.z = (r2.x * r7.x) + (r2.y * r7.y) + (r2.z * r7.z);
    r8.xyz = norm(r6);
    texcoord_1.xyz = r8;
    r5.xyz = r5 * r2.w;
    r8.xyz = norm(r1);
    texcoord_3.xyz = r8;
    r1.x = (r4.x * r5.x) + (r4.y * r5.y) + (r4.z * r5.z);
    r1.y = (r3.x * r5.x) + (r3.y * r5.y) + (r3.z * r5.z);
    r1.z = (r2.x * r5.x) + (r2.y * r5.y) + (r2.z * r5.z);
    r6.xyz = SkinModelViewProj[0]7 - r0;
    r7.x = (r6.x * r6.x) + (r6.y * r6.y) + (r6.z * r6.z);
    r1.w = 1.0 / sqrt(r7.x);
    r8.xyz = norm(r1);
    texcoord_6.xyz = r8;
    r1.xyz = r6 * r1.w;
    r5.xyz = (r1.w * r6) + r5;
    texcoord_2.x = (r4.x * r1.x) + (r4.y * r1.y) + (r4.z * r1.z);
    texcoord_2.y = (r3.x * r1.x) + (r3.y * r1.y) + (r3.z * r1.z);
    texcoord_2.z = (r2.x * r1.x) + (r2.y * r1.y) + (r2.z * r1.z);
