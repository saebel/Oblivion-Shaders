...
//
    ...
    r1.xyzw = lerp(r0.xyzw, Color2.rgba, r3.y);
    r0.xyzw = lerp(r2.xyzw, Color3.rgba, r3.y);
    r2.xyzw = lerp(r1.xyzw, Color3.rgba, r3.z);
    r1.xyzw = lerp(r0.xyzw, const_13.zzzw, r3.z);
    r3.w = 1.0 / fVars1.w;
    r0.xyzw = lerp(r2.xyzw, r1.xyzw, r5.w);
