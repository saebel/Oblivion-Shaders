...
//
    ...
    r6.x = (r5.x * LightDirection[0].x) + (r5.y * LightDirection[0].y) + (r5.z * LightDirection[0].z);
    r4.xyz = (input_5.z * r1) + r2;
    ...
    r4.xyz = norm(r2);
    r2.xyz = norm(r1);
    r6.y = (r4.x * LightDirection[0].x) + (r4.y * LightDirection[0].y) + (r4.z * LightDirection[0].z);
    r6.z = (r2.x * LightDirection[0].x) + (r2.y * LightDirection[0].y) + (r2.z * LightDirection[0].z);
    r3.x = (r6.x * r6.x) + (r6.y * r6.y) + (r6.z * r6.z);
    r1.xyz = SkinModelViewProj[0]7 - r0;
    r1.w = 1.0 / sqrt(r3.x);
    r3.xyz = norm(r1);
    texcoord_1.xyz = r6 * r1.w;
