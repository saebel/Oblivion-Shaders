...
//
    ...
    r1.w = dot(IN.normal, const_46);
    r0.w = dot(const_46, r0);
    r0.z = max(r1.w, const_4.z);
    ...
    r0.z = dot(const_50, r0);
    r0.w = dot(IN.normal, const_50);
    ...
    r1.w = dot(IN.normal, const_54);
    r0.w = dot(const_54, r0);
    r0.z = max(r1.w, const_4.z);
    ...
    r0.z = dot(const_58, r0);
    r0.w = dot(IN.normal, const_58);
    ...
    r1.w = dot(IN.normal, const_62);
    r0.w = dot(const_62, r0);
    r0.z = max(r1.w, const_4.z);
    ...
    r0.w = dot(IN.normal, const_66);
    r1.y = dot(const_65, r0);
    r0.w = max(r0.w, const_4.z);
    r0.z = dot(const_66, r0);
    r1.w = const_4.w - r0.w;
    OUT.texcoord_6.xy = (const_4.x * r1) + const_4.y;
    r0.w = pow(abs(r1.w), const_5.x);
    ...
    r0.z = const_70.w;
    r0.xyz = r0 + IN.position;
    r0.w = dot(IN.normal, const_70);
    r1.x = dot(const_68, r0);
    r0.w = max(r0.w, const_4.z);
    r1.y = dot(const_69, r0);
    r1.w = const_4.w - r0.w;
    r0.z = dot(const_70, r0);
    r0.w = pow(abs(r1.w), const_5.x);
    r0.z = (abs(r0.z) * -const_5.y) + const_5.z;
