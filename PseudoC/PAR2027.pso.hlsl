...
//
    ...
    r5.x = saturate(dot(r2, r5));			// partial precision
    ...
    r5.x = dot(r2, r5);			// partial precision
    ...
    r4.x = saturate(dot(r2, r4));			// partial precision
    ...
    r2.w = max(r4.w, const_4.x);			// partial precision
    ...
    r3.xyz = (r0.w * PSLightColor[0]) + r3;			// partial precision
    r4.xyz = AmbientColor;
