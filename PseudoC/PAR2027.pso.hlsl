...
//
    ...
    r2.xyz = r2.xyz - 0.5;
    r5.xyz = 2 * r2.xyz;			// partial precision
    r2.xyz = normalize(r5.xyz);			// partial precision
    r5.xyz = normalize(IN.texcoord_4.xyz);			// partial precision
    r5.x = saturate(dot(r2.xyz, r5.xyz));			// partial precision
    r0.w = pow(abs(r5.x), Toggles.z);			// partial precision
    ...
    r4.x = saturate(dot(r2.xyz, r4.xyz));			// partial precision
    r3.w = pow(abs(r4.x), Toggles.z);			// partial precision
    r4.x = dot(r2.xyz, IN.texcoord_1.xyz);			// partial precision
    r3.w = r2.w * r3.w;			// partial precision
    r4.w = r4.x - -0.5;			// partial precision
    ...
    r3.xyz = saturate(r1.w * r2.xyz);			// partial precision
    r0.w = (r0.w >= 0.0 ? r3.w : r2.w);			// partial precision
    r2.xyz = saturate(r0.w * PSLightColor[0].rgb);			// partial precision
    ...
    r3.xyz = (r0.w * PSLightColor[0].rgb) + r3.xyz;			// partial precision
