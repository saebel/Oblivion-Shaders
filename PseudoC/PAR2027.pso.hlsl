...
//
    ...
    r3.w = pow(abs(r4.x), Toggles.z);			// partial precision
    r4.x = dot(r2.xyz, IN.texcoord_1.xyz);			// partial precision
    r3.w = r2.w * r3.w;			// partial precision
    r4.w = r4.x - -0.5;			// partial precision
    r2.w = max(r4.w, 0);			// partial precision
    r2.w = r3.w * r2.w;			// partial precision
    ...
    r0.w = 0.2 - r4.x;			// partial precision
    r3.xyz = saturate(r1.w * r2.xyz);			// partial precision
    r0.w = (r0.w >= 0.0 ? r2.w : r3.w);			// partial precision
    r2.xyz = saturate(r0.w * PSLightColor[0].rgb);			// partial precision
    ...
    r0.w = saturate(r4.x);			// partial precision
    r3.xyz = r1.w * r3.xyz;			// partial precision
    r3.xyz = (r0.w * PSLightColor[0].rgb) + r3.xyz;			// partial precision
    r4.xyz = AmbientColor.rgb;
    r0.xyz = (r0.xyz * EmittanceColor.rgb) + r4.xyz;			// partial precision
