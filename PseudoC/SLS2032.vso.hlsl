...
//
    ...
    r6.x = dot(r4, r4);	// normalize + length
    r1.w = 1.0 / sqrt(r6.x);
    r4.xyz = (r1.w * r4) + LightDirection[0];
    r5.xyz = normalize(r1);
    OUT.texcoord_1.xyz = r5;
    r1.xyz = normalize(r4);
    OUT.texcoord_3.x = dot(r3, r1);
    OUT.texcoord_3.y = dot(r2, r1);
    OUT.texcoord_3.z = dot(r0, r1);
