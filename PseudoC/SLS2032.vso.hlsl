...
//
    ...
    r3.xyz = norm(r1);
    r1.x = (r3.x * LightDirection.x) + (r3.y * LightDirection.y) + (r3.z * LightDirection.z);
    ...
    r6.x = (r4.x * r4.x) + (r4.y * r4.y) + (r4.z * r4.z);
    r1.w = 1.0 / sqrt(r6.x);
    r4.xyz = (r1.w * r4) + LightDirection;
    r5.xyz = norm(r1);
    texcoord_1.xyz = r5;
    r1.xyz = norm(r4);
    texcoord_3.x = (r3.x * r1.x) + (r3.y * r1.y) + (r3.z * r1.z);
    texcoord_3.y = (r2.x * r1.x) + (r2.y * r1.y) + (r2.z * r1.z);
    texcoord_3.z = (r0.x * r1.x) + (r0.y * r1.y) + (r0.z * r1.z);
