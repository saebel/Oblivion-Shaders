...
//
    ...
    if_ne 0, r0.w
      ...
      r3.xyz = (0.5 * r3.xyz) + r0.w;			// partial precision
      r2.xyz = (r0.x * r2.xyz) + 1;			// partial precision
    ...
    if_lt 7, r3.w
      ...
      r0.xyz = normalize(r6.xyz);			// partial precision
      r0.w = 1.0 / sqrt(r0.w);
      ...
      r0.xyz = (r5.x == 0.0 ? LightData[14].xyz : r11.y);			// partial precision
      r4.w = r2.w * r2.w;			// partial precision
      r0.xyz = (r5.y == 0.0 ? LightData[15].xyz : r0.xyz);			// partial precision
    ...
    r1.xyz = 2 * r2.xyz;			// partial precision
