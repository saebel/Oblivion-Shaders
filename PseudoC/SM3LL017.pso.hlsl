...
//
    ...
    if_ne r0.w, -r0.w
      r3.x = (r6.x * LightData[1].x) + (r6.y * LightData[1].y) + (r6.z * LightData[1].z);			// partial precision
      r3.y = (r8.x * LightData[1].x) + (r8.y * LightData[1].y) + (r8.z * LightData[1].z);			// partial precision
      r3.z = (r7.x * LightData[1].x) + (r7.y * LightData[1].y) + (r7.z * LightData[1].z);			// partial precision
      ...
      r0.xyz = (r3 >= const_7.y ? r3 : const_7.y);			// partial precision
    ...
    if_ne r0.w, -r0.w
      ...
      r4.w = (r5.w >= const_7.y ? r5.w : const_7.y);			// partial precision
      ...
      r4.w = (r6.w >= const_7.y ? r6.w : const_7.y);			// partial precision
      ...
      r2.xyz = r0 * r4.w;			// partial precision
      r0.xyz = (r9 >= const_7.y ? r9 : const_7.y);			// partial precision
    ...
    if_lt -EyePosition7.z, r3.w
      ...
      r0.w = sat(r0.w * r0.z);
      r0.z = (r4.w >= const_7.y ? r4.w : const_7.y);			// partial precision
      ...
      r2.w = (r4.w >= const_7.y ? r4.w : const_7.y);			// partial precision
      ...
      r1.xyz = r0 * r2.w;			// partial precision
      r0.xyz = (r2 >= const_7.y ? r2 : const_7.y);			// partial precision
