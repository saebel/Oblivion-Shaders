...
//
    ...
    r5 = tex2D(ShadowMaskMap, r2);			// partial precision
    r6 = tex2D(ShadowMap, IN.texcoord_6);			// partial precision
    ...
    r0.x = dot(r7, r0);			// partial precision
    r1.w = max(r0.x, const_0.w);			// partial precision
    ...
    r4.x = dot(r7, r6);			// partial precision
    r0.xyz = r0 * -const_0.x;			// partial precision
    r3.w = max(r4.x, const_0.w);			// partial precision
    r2.w = saturate(r2.w - r3.x);			// partial precision
    r0.xyz = (r3.w * PSLightColor[1]) + r0;			// partial precision
    r4.xyz = r2.w * r0;			// partial precision
    r6.x = dot(r7, IN.texcoord_1);			// partial precision
    r3.xyz = r1.w * PSLightColor[0];			// partial precision
    r0.xyz = r1.w * PSLightColor[2];			// partial precision
    r1.w = max(r6.x, const_0.w);			// partial precision
    ...
    r4.x = dot(r7, r4);			// partial precision
    r2.w = max(r4.x, const_0.w);			// partial precision
    r0.xyz = r0 * -const_0.x;			// partial precision
