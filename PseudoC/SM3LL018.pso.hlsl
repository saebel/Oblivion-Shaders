...
//
    ...
    if_ne r0.w, -r0.w
      r0.x = (r3.x * LightData[1].x) + (r3.y * LightData[1].y) + (r3.z * LightData[1].z);			// partial precision
      r0.y = (r5.x * LightData[1].x) + (r5.y * LightData[1].y) + (r5.z * LightData[1].z);			// partial precision
      r0.z = (r4.x * LightData[1].x) + (r4.y * LightData[1].y) + (r4.z * LightData[1].z);			// partial precision
