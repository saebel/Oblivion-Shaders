...
//
    ...
    r4.w = saturate(r0.x);			// partial precision
    ...
    r3.xyz = r4.w * PSLightColor[0].rgb;			// partial precision
    r5.xyz = AmbientColor.rgb;
    r1.xyz = (r1.xyz * EmittanceColor.rgb) + r5.xyz;			// partial precision
    r3.xyz = (r4.xyz * r3.xyz) + r1.xyz;			// partial precision
