...
//
    ...
    r6.x = (r4.x * LightDirection.x) + (r4.y * LightDirection.y) + (r4.z * LightDirection.z);
    r1.xyz = (r1.w * r1) + r2;
    r3.xyz = norm(r1);
    ...
    r6.y = (r3.x * LightDirection.x) + (r3.y * LightDirection.y) + (r3.z * LightDirection.z);
    r5.xyz = (input_6.z * r1) + r2;
    ...
    r5.xyz = (r1.w * r2) + r5;
    r7.x = (r1.x * r1.x) + (r1.y * r1.y) + (r1.z * r1.z);
    r2.xyz = norm(r5);
    r1.w = 1.0 / sqrt(r7.x);
    r6.z = (r2.x * LightDirection.x) + (r2.y * LightDirection.y) + (r2.z * LightDirection.z);
    r5.xyz = (r1.w * r1) + LightDirection;
    r7.xyz = norm(r5);
    r5.x = (r4.x * r7.x) + (r4.y * r7.y) + (r4.z * r7.z);
    r5.y = (r3.x * r7.x) + (r3.y * r7.y) + (r3.z * r7.z);
    r5.z = (r2.x * r7.x) + (r2.y * r7.y) + (r2.z * r7.z);
    r7.xyz = norm(r6);
    texcoord_1.xyz = r7;
    r6.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r2.w = 1.0 / sqrt(r6.x);
    r6.xyz = SkinModelViewProj[0]7 - r0;
    texcoord_3.xyz = r5 * r2.w;
    r5.xyz = norm(r6);
    texcoord_2.x = (r4.x * r5.x) + (r4.y * r5.y) + (r4.z * r5.z);
    texcoord_2.y = (r3.x * r5.x) + (r3.y * r5.y) + (r3.z * r5.z);
    texcoord_2.z = (r2.x * r5.x) + (r2.y * r5.y) + (r2.z * r5.z);
    r5.xyz = (r1.w * r1) + r5;
    ...
    r0.xyz = r6 * r1.w;
    r6.x = (r1.x * r1.x) + (r1.y * r1.y) + (r1.z * r1.z);
    ...
    r1.w = 1.0 / FogParam.y;
    texcoord_4.x = (r4.x * r0.x) + (r4.y * r0.y) + (r4.z * r0.z);
    r0.w = r0.w * r1.w;
    texcoord_4.y = (r3.x * r0.x) + (r3.y * r0.y) + (r3.z * r0.z);
    r0.w = (r0.w >= const_0.z ? r0.w : const_0.z);
    texcoord_4.z = (r2.x * r0.x) + (r2.y * r0.y) + (r2.z * r0.z);
