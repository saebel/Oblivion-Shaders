...
//
    ...
    r1.xyz = input_3 * const_4.x;
    texcoord_1.x = (r1.x * const_8.x) + (r1.y * const_8.y) + (r1.z * const_8.z);
    r0.xyz = input_4 * const_4.x;
    texcoord_1.y = (r0.x * const_8.x) + (r0.y * const_8.y) + (r0.z * const_8.z);
    texcoord_1.z = (input_2.x * const_8.x) + (input_2.y * const_8.y) + (input_2.z * const_8.z);
    texcoord_2.x = (r1.x * const_9.x) + (r1.y * const_9.y) + (r1.z * const_9.z);
    texcoord_3.x = (r1.x * ModelViewProj[1]0.x) + (r1.y * ModelViewProj[1]0.y) + (r1.z * ModelViewProj[1]0.z);
    texcoord_2.y = (r0.x * const_9.x) + (r0.y * const_9.y) + (r0.z * const_9.z);
    texcoord_3.y = (r0.x * ModelViewProj[1]0.x) + (r0.y * ModelViewProj[1]0.y) + (r0.z * ModelViewProj[1]0.z);
