...
//
    ...
    r3.xyz = saturate(r2.xyz * r3.w);			// partial precision
    r1.w = (r1.w >= 0.0 ? r4.w : r2.w);			// partial precision
    r2.xyz = saturate(r1.w * PSLightColor[0].rgb);			// partial precision
    ...
    r0.xyz = (Toggles.x <= 0.0 ? r3.xyz : r0.xyz);			// partial precision
