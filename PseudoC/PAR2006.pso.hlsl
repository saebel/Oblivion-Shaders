...
//
    ...
    r3.xyzw = tex2D(AttenuationMap, r2.xy);			// partial precision
    r4.xyzw = tex2D(AttenuationMap, IN.texcoord_4.xy);			// partial precision
    r5.xyzw = tex2D(NormalMap, r0.xy);			// partial precision
    ...
    r6.x = saturate(dot(r5.xyz, r6.xyz));			// partial precision
    r0.w = -(r4.x - 1);			// partial precision
    r4.x = saturate(dot(r5.xyz, IN.texcoord_1.xyz));			// partial precision
    r0.w = saturate(r0.w - r3.x);			// partial precision
    r3.xyz = r6.x * PSLightColor[1].rgb;			// partial precision
    r3.xyz = r0.w * r3.xyz;			// partial precision
    r2.xyz = r2.xyz - 1;			// partial precision
    r2.xyz = (r1.x * r2.xyz) - -1;			// partial precision
    r1.xyz = r4.x * PSLightColor[0].rgb;			// partial precision
