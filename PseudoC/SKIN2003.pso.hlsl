...
//
    ...
    r1.w = max(r7.x, const_4.x);			// partial precision
    ...
    r2.w = max(r10.x, const_4.x);			// partial precision
    ...
    r1.w = max(r6.x, const_4.x);			// partial precision
    ...
    r3.xyz = max(r4, const_4.x);			// partial precision
