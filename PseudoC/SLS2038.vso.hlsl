...
//
    ...
    r3.xyz = r1 * const_0.w;
    OUT.texcoord_1.x = dot(r3, SkinToCubeSpace[0]);
    ...
    r1.xyz = r1 * const_0.w;
    r2.xyz = normalize(r4);
    OUT.texcoord_1.y = dot(r1, SkinToCubeSpace[0]);
    OUT.texcoord_1.z = dot(r2, SkinToCubeSpace[0]);
    OUT.texcoord_2.x = dot(r3, SkinToCubeSpace[1]);
    OUT.texcoord_3.x = dot(r3, SkinToCubeSpace[2]);
    OUT.texcoord_2.y = dot(r1, SkinToCubeSpace[1]);
    OUT.texcoord_3.y = dot(r1, SkinToCubeSpace[2]);
    OUT.texcoord_2.z = dot(r2, SkinToCubeSpace[1]);
    r1.x = dot(SkinToCubeSpace[0], r0);
    r1.y = dot(SkinToCubeSpace[1], r0);
    r1.z = dot(SkinToCubeSpace[2], r0);
    OUT.texcoord_3.z = dot(r2, SkinToCubeSpace[2]);
