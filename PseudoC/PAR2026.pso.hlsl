...
//
    ...
    r1.xyz = r1.xyz - 0.5;
    r4.xyz = 2 * r1.xyz;			// partial precision
    r1.xyz = normalize(r4.xyz);			// partial precision
    r4.xyz = normalize(IN.texcoord_4.xyz);			// partial precision
    ...
    r1.xyz = saturate(r0.w * PSLightColor[0].rgb);			// partial precision
