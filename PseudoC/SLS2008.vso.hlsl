...
//
    ...
    r5.xyz = normalize(r3);
    r3.xyz = normalize(r2);
    r1.y = dot(r5, LightDirection[0]);
    r1.z = dot(r3, LightDirection[0]);
    r0.w = 1;
    ...
    OUT.texcoord_2.x = dot(r6, r4);
    r0.x = dot(r1, r1);	// normalize + length
    OUT.texcoord_2.y = dot(r5, r4);
    r0.w = 1.0 / sqrt(r0.x);
    OUT.texcoord_2.z = dot(r3, r4);
    r0.w = 1.0 / r0.w;
