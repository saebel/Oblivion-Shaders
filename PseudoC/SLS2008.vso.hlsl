...
//
    ...
    r1.x = (r6.x * LightDirection.x) + (r6.y * LightDirection.y) + (r6.z * LightDirection.z);
    ...
    r5.xyz = norm(r3);
    r3.xyz = norm(r2);
    r1.y = (r5.x * LightDirection.x) + (r5.y * LightDirection.y) + (r5.z * LightDirection.z);
    r1.z = (r3.x * LightDirection.x) + (r3.y * LightDirection.y) + (r3.z * LightDirection.z);
    r0.w = const_0.x;
