...
//   SkinWorldView[0]     SkinWorldView[0]       1
//   SkinWorldView[1]     SkinWorldView[1]       1
//   SkinWorldView[2]     SkinWorldView[2]       1
//   Bones[0]          Bones[0]     17
//   Bones[1]          Bones[1]     17
//   Bones[2]          Bones[2]     17
//
    ...
    output_2.x = (SkinWorldView[0].x * r0.x) + (SkinWorldView[0].y * r0.y) + (SkinWorldView[0].z * r0.z) + (SkinWorldView[0].w * r0.w);
    output_2.y = (SkinWorldView[1].x * r0.x) + (SkinWorldView[1].y * r0.y) + (SkinWorldView[1].z * r0.z) + (SkinWorldView[1].w * r0.w);
    output_2.z = (SkinWorldView[2].x * r0.x) + (SkinWorldView[2].y * r0.y) + (SkinWorldView[2].z * r0.z) + (SkinWorldView[2].w * r0.w);
    output_1.xy = input_1;
    output_2.w = const_0.z;
