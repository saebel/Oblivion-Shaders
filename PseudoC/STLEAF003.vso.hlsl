...
//
    ...
    r1.xy = (r2.w * (1.0 / (PI * 2))) + const_82.yz;
    r1.w = (r0.w * r1.w) - 0.5;
    r0.xy = frac(r1.xy);
    r0.w = (r0.w * r1.w) + 1;
    r0.xy = (PI * 2 * r0.xy) - PI;
    ...
    r3.xy = (r0.w * (1.0 / (PI * 2))) + const_82.yz;
    ...
    r0.xyz = r0.xyz * r0.w;
    r0.xyz = (LeafLighting.y * r0.xyz) + IN.normal.xyz;
    ...
    r1.w = SunDimmer.x;
    r1.xyzw = (r1.w * r0.xyzw) + AmbientColor.rgba;
    r6.y = pow(2.0, IN.blendindices.z);	// partial precision
    r4.w = r6.y;
    r0.xyzw = r5.w * DiffColorPt.xyzw;
    r1.xyz = r1.xyz * r4.w;
    ...
    r3.w = 1.0 - (r3.w * r3.w);
    r2.w = max(r2.w, 0);
    OUT.texcoord_1.xyzw = (r3.w * r0.xyzw) + r1.xyzw;
    r0.w = min(r2.w, 1);
