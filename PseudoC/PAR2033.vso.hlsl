...
//
    ...
    r3.x = (r1.x * LightDirection[0].x) + (r1.y * LightDirection[0].y) + (r1.z * LightDirection[0].z);
    r2.xyz = (r1.w * r2) + r4;
    r5.xyz = norm(r2);
    ...
    r3.y = (r5.x * LightDirection[0].x) + (r5.y * LightDirection[0].y) + (r5.z * LightDirection[0].z);
    r4.xyz = (r1.w * r2) + r4;
    r2.xyz = norm(r4);
    ...
    r6.x = (r3.x * r3.x) + (r3.y * r3.y) + (r3.z * r3.z);
    r1.w = 1.0 / sqrt(r7.x);
    r2.w = 1.0 / sqrt(r6.x);
    r6.xyz = (r1.w * r4) + LightDirection[0];
    texcoord_1.xyz = r3 * r2.w;
    r3.xyz = norm(r6);
    r4.xyz = r4 * r1.w;
    ...
    r1.z = (r2.x * r4.x) + (r2.y * r4.y) + (r2.z * r4.z);
