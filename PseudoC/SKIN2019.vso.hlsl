...
//
    ...
    OUT.texcoord_7.xyz = r5 * r0.w;
    r5.xyz = normalize(r2);
    OUT.texcoord_1.x = dot(r4, r5);
    OUT.texcoord_1.y = dot(r3, r5);
    OUT.texcoord_1.z = dot(r1, r5);
    r0.w = 1.0 / LightPosition[0].w;
    r5.xyz = r2 * r0.w;
    r2.xyz = LightPosition[1] - r0;
    OUT.texcoord_4.xyz = (const_0.w * r5) + const_0.w;
    r5.xyz = normalize(r2);
    ...
    r2.xyz = r2 * r0.w;
    OUT.texcoord_5.xyz = (const_0.w * r2) + const_0.w;
    r2.xyz = normalize(r0);
    ...
    OUT.texcoord_6.xyz = (const_0.w * r0) + const_0.w;
    OUT.texcoord_0.xy = IN.texcoord_0;
    OUT.texcoord_4.w = const_0.w;
    OUT.texcoord_5.w = const_0.w;
    OUT.texcoord_6.w = const_0.w;
