...
//
    ...
    r3.xyz = norm(r1);
    r1.xyz = norm(r6);
    r5.y = (r3.x * r2.x) + (r3.y * r2.y) + (r3.z * r2.z);
    r5.z = (r1.x * r2.x) + (r1.y * r2.y) + (r1.z * r2.z);
    ...
    r2.xyz = r2 * r0.w;
    texcoord_5.xyz = (const_0.w * r2) + const_0.w;
    r2.xyz = norm(r0);
