...
//
    ...
    r8.x = dot(r2.wxzw, IN.normal);
    r1.xyz = r1 + InstanceData[0 + offset.w];
    r7.x = dot(r2, IN.normal);
    r6.xy = r1 + ShadowProjTransform;
    r0.w = 1.0 / ShadowProjTransform.w;
    r2.xyz = r5 * r8.x;
    OUT.texcoord_2.xy = r6 * r0.w;
    r2.xyz = (r7.x * r4) + r2;
    r4.xy = r1 - ShadowProjData;
