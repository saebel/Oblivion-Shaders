...
//
    ...
    r5.xy = saturate((r0.w * const_5.xy) + r0.xy);
    r4.xy = saturate((r0.w * const_4.xy) + r0.xy);
    r3.xy = saturate((r0.w * -const_5.xy) + r0.xy);
