...
//
    ...
    r9 = tex2D(ShadowMap, r8);
    r8 = tex2D(ShadowMap, r7);
    r7 = tex2D(ShadowMap, r6);
    r6 = tex2D(ShadowMap, r5);
    r5 = tex2D(ShadowMap, r4);
    r4 = tex2D(ShadowMap, r3);
    r3 = tex2D(ShadowMap, r2);
    r2 = tex2D(ShadowMap, r1);
    r1 = tex2D(ShadowMap, r0);
    r0 = tex2D(BaseMap, IN.texcoord_0);			// partial precision
    r2.w = 1.0 / IN.texcoord_2.w;
    r1.w = (IN.texcoord_1.z * -r2.w) + r9.x;
    r1.w = const_1.x - r1.w;
    r1.w = (r1.w >= 0.0 ? const_0.y : const_0.w);			// partial precision
    r3.w = (IN.texcoord_1.z * -r2.w) + r8.x;
    r3.w = const_1.x - r3.w;
    r3.w = (r3.w >= 0.0 ? const_0.y : const_0.w);			// partial precision
    r1.w = r1.w + r3.w;			// partial precision
    r3.w = (IN.texcoord_1.z * -r2.w) + r7.x;
    r3.w = const_1.x - r3.w;
    r3.w = (r3.w >= 0.0 ? const_0.y : const_0.w);			// partial precision
    r1.w = r1.w + r3.w;			// partial precision
    r3.w = (IN.texcoord_1.z * -r2.w) + r6.x;
    r3.w = const_1.x - r3.w;
    r3.w = (r3.w >= 0.0 ? const_0.y : const_0.w);			// partial precision
    r1.w = r1.w + r3.w;			// partial precision
    r3.w = (IN.texcoord_1.z * -r2.w) + r5.x;
    r3.w = const_1.x - r3.w;
    r3.w = (r3.w >= 0.0 ? const_0.y : const_0.w);			// partial precision
    r1.w = r1.w + r3.w;			// partial precision
    ...
    r1.w = saturate(r1.w * const_3.z);			// partial precision
    ...
    r1.xyz = lerp(const_0.y, r0, r3.w);			// partial precision
    r1.w = min(r0.w, const_0.y);			// partial precision
