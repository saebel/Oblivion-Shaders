...
//
    ...
    r0.xyz = r1 + const_31.x;			// partial precision
    r0.xyz = r0 + r0;			// partial precision
    r5.xyz = normalize(r0);			// partial precision
    r0.xyz = r5 * -const_31.x;			// partial precision
    r0.w = r0.z + const_31.z;			// partial precision
    r1.xyz = r0 + const_31.yyzw;			// partial precision
    ...
    if_ne r4.w, -r4.w
      ...
      r3.xyz = r3 + const_31.w;			// partial precision
      r0.w = max(r4.w, const_31.y);			// partial precision
      r3.xyz = (r2.x * r3) + const_31.z;			// partial precision
    ...
    r2.w = (r3.y >= 0.0 ? const_31.z : const_31.y);
    r15.xyz = r2 - IN.input_5;
    r3.z = r3.y - floor(r3.y);			// partial precision
    r2.x = dot(r12, r15);
    r2.y = dot(r11, r15);
    r2.z = dot(r10, r15);
    r3.w = (r3.z <= 0.0 ? const_31.z : const_31.y);
    ...
    r5.w = (r4.w <= 0.0 ? const_31.z : const_31.y);
    ...
    if_ne r5.w, -r5.w
      ...
      r3.w = (r2.z * -r2.z) + const_31.z;			// partial precision
      r2.xyz = r13.x + const_7.zxyw;
    ...
    if_lt const_31.z, r4.w
      ...
      r0.w = max(r2.w, const_31.y);			// partial precision
      r5.w = r5.w + const_31.z;
      r4.xyz = (r0.w * r2) + r4;			// partial precision
    endif
    r7.w = r5.w + r5.w;
    r13.xyz = r7.w + const_25;
    ...
    r7.xyz = LightData[15] - IN.input_5;
    r2.x = dot(r12, r7);
    r2.y = dot(r11, r7);
    r2.z = dot(r10, r7);
    ...
    if_lt const_27.w, r4.w
      ...
      r4.w = (r0.z * -r0.z) + const_31.z;			// partial precision
      r2.w = r2.w * const_4.z;			// partial precision
      r3.xy = (const_29.x * r5.w) + const_29.yzzw;
      r2.xyz = r6.x + HairTint;			// partial precision
      r0.xyz = (r3.x == 0.0 ? LightData[14] : r6.y);			// partial precision
      r2.xyz = (IN.color_0.g * r2) - const_31.x;			// partial precision
      r0.xyz = (r3.y == 0.0 ? LightData[15] : r0);			// partial precision
      r5.xyz = (const_30.x * r2) + const_30.y;			// partial precision
      ...
      r2.w = max(r3.z, const_31.y);			// partial precision
      r0.w = max(r3.w, const_31.y);			// partial precision
      r1.xyz = (r2.w * r2) + r1;			// partial precision
      r4.xyz = (r0.w * r0) + r4;			// partial precision
    endif
    r0.xyz = r6.x + HairTint;			// partial precision
    r0.xyz = (IN.color_0.g * r0) - const_31.x;			// partial precision
