...
//
    ...
    r0 = r0 - floor(r0);
    r1.x = (input_1.x * const_0.x.x) + (input_1.y * const_0.x.y) + (input_1.z * const_0.x.z);
    r0 = (input_2.zyxw * const_0.y) - r0;
    mova a0, r0
    ...
    texcoord_1.x = (SkinWorldViewTranspose[0].x * r0.x) + (SkinWorldViewTranspose[0].y * r0.y) + (SkinWorldViewTranspose[0].z * r0.z) + (SkinWorldViewTranspose[0].w * r0.w);
    texcoord_1.y = (SkinWorldViewTranspose[1].x * r0.x) + (SkinWorldViewTranspose[1].y * r0.y) + (SkinWorldViewTranspose[1].z * r0.z) + (SkinWorldViewTranspose[1].w * r0.w);
    texcoord_1.z = (SkinWorldViewTranspose[2].x * r0.x) + (SkinWorldViewTranspose[2].y * r0.y) + (SkinWorldViewTranspose[2].z * r0.z) + (SkinWorldViewTranspose[2].w * r0.w);
