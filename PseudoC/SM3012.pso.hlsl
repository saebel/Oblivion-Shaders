...
//
    ...
    if_ne r0.w, -r0.w
      ...
      r2.w = max(r0.w, const_7.y);			// partial precision
    ...
    if_ne r0.w, -r0.w
      ...
      r0.w = max(r1.y, const_7.y);			// partial precision
    ...
    if_lt -const_4.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[9] : r3.y);
      r0 = (r1.y == 0.0 ? LightData[10] : r0);
      r0 = (r1.z == 0.0 ? LightData[11] : r0);
      r8.xyz = r0 - IN.input_5;
      r0.z = dot(r8, r8);	// normalize + length
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[8] : r3.y);			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r7, r8);
      r9.y = dot(r6, r8);
    ...
    if_lt -const_40.w, r2.w
      ...
      r0.w = max(r1.w, const_7.y);			// partial precision
