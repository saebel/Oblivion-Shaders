...
//
    ...
    r0.xyz = r0 - const_7.x;			// partial precision
    ...
    if_ne r0.w, -r0.w
      ...
      r2.w = (r0.w >= const_7.y ? r0.w : const_7.y);			// partial precision
      r0 = ShadowMask[input_6.zwzw];			// partial precision
      r1 = ShadowMap[input_6];			// partial precision
      r1.xyz = r1 - const_7.w;			// partial precision
      r1.xyz = (r0.x * r1) - const_7.z;			// partial precision
    ...
    r0.w = const_1.x;			// partial precision
    ...
    r2.w = (r0.w * r0.z) - r0.y;
    r0.w = (r2.w <= 0.0 ? const_7.z : const_7.y);
    if_ne r0.w, -r0.w
      r1.x = r1.w - r1.w;
      r1.yz = r1.x - const_1;
      r0.xyz = r1.x - const_1.wyzw;
      r1.xyz = (r0 >= 0.0 ? -r1 : r0);
      r0 = (r1.x <= 0.0 ? r3.y : LightData[01]);
      r0 = (r1.y <= 0.0 ? r0 : LightData[02]);
      r0 = (r1.z <= 0.0 ? r0 : LightData[03]);
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x <= 0.0 ? r3.y : LightData[00]);			// partial precision
      r1.x = 1.0 / r3.w;
      ...
      r1.x = (r1.x * -r1.x) - const_7.z;			// partial precision
      r0.xyz = (r1.y <= 0.0 ? r0 : LightData[01]);			// partial precision
      r1.y = r0.w * r1.x;			// partial precision
      r0.xyz = (r1.z <= 0.0 ? r0 : LightData[02]);			// partial precision
      r0.w = (r1.y >= const_7.y ? r1.y : const_7.y);			// partial precision
      r2.xyz = (r0.w * r0) + r2;			// partial precision
      r1.w = r1.w - const_7.z;
    endif
    if_lt const_7.z, r2.w
      r1.xyz = (const_4.x * r1.w) - const_4.yzww;
      r0 = (r1.x == 0.0 ? LightData[03] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[04] : r0)
      r0 = (r1.z == 0.0 ? LightData[05] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[02] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
      ...
      r0.w = (r4.x * r8.x) + (r4.y * r8.y) + (r4.z * r8.z);			// partial precision
      r1.x = (r1.x * -r1.x) - const_7.z;			// partial precision
      r0.xyz = (r1.y == 0.0 ? LightData[03] : r0)			// partial precision
      r1.y = r0.w * r1.x;			// partial precision
      r0.xyz = (r1.z == 0.0 ? LightData[04] : r0)			// partial precision
      r0.w = (r1.y >= const_7.y ? r1.y : const_7.y);			// partial precision
      r2.xyz = (r0.w * r0) + r2;			// partial precision
      r1.w = r1.w - const_7.z;
    endif
    if_lt -const_1.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[05] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[06] : r0)
      r0 = (r1.z == 0.0 ? LightData[07] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[04] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_4.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[07] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[08] : r0)
      r0 = (r1.z == 0.0 ? LightData[09] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[06] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_4.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[09] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[10] : r0)
      r0 = (r1.z == 0.0 ? LightData[11] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[08] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_8.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[11] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[12] : r0)
      r0 = (r1.z == 0.0 ? LightData[13] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[10] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_8.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[13] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[14] : r0)
      r0 = (r1.z == 0.0 ? LightData[15] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[12] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_48.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[15] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[16] : r0)
      r0 = (r1.z == 0.0 ? LightData[17] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[14] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_48.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[17] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[18] : r0)
      r0 = (r1.z == 0.0 ? LightData[19] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[16] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -MatAlpha9.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[19] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[20] : r0)
      r0 = (r1.z == 0.0 ? LightData[21] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[18] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -MatAlpha9.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[21] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[22] : r0)
      r0 = (r1.z == 0.0 ? LightData[23] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[20] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_41.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[23] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[24] : r0)
      r0 = (r1.z == 0.0 ? LightData[25] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[22] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_41.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[25] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[26] : r0)
      r0 = (r1.z == 0.0 ? LightData[27] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[24] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_40.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[27] : r3.y)
      r0 = (r1.y == 0.0 ? LightData[28] : r0)
      r0 = (r1.z == 0.0 ? LightData[29] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r3.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[26] : r3.y)			// partial precision
      r1.x = 1.0 / r3.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_40.w, r2.w
      ...
      r0.w = (r4.x * r0.x) + (r4.y * r0.y) + (r4.z * r0.z);			// partial precision
      r0.z = sat(r1.z * r1.y);
      r0.z = (r0.z * -r0.z) - const_7.z;			// partial precision
      r1.xy = (const_47.x * r1.w) - const_47.yzzw;
      r1.w = r0.w * r0.z;			// partial precision
      r0.xyz = (r1.x == 0.0 ? LightData[28] : r3.y)			// partial precision
      r0.w = (r1.w >= const_7.y ? r1.w : const_7.y);			// partial precision
