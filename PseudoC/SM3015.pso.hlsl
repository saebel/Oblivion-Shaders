...
//
    ...
    if_ne 0, r1.w
      r4.x = dot(r9.xyz, LightData[1].xyz);			// partial precision
      r4.y = dot(r8.xyz, LightData[1].xyz);			// partial precision
      r4.z = dot(r7.xyz, LightData[1].xyz);			// partial precision
    ...
    if_ne 0, r1.w
      ...
      r10.xyz = (r1.xyz >= 0.0 ? r1.xyz : -r4.xyz);
      r1.xyzw = (r10.x <= 0.0 ? LightData[1].xyzw : r5.x);
      r1.xyzw = (r10.y <= 0.0 ? LightData[2].xyzw : r1.xyzw);
      r1.xyzw = (r10.z <= 0.0 ? LightData[3].xyzw : r1.xyzw);
      r11.xyz = (r10.x <= 0.0 ? LightData[0].xyz : r5.x);			// partial precision
      ...
      r1.w = 1.0 / r1.w;			// partial precision
      r4.w = pow(abs(r5.z), ToggleNumLights.z);			// partial precision
    ...
    if_lt 1, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[2].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 2, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[4].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 3, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[6].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 4, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[8].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 5, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[10].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 6, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[12].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 7, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[14].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 8, r2.w
      ...
      r11.xyz = (r10.x == 0.0 ? LightData[16].xyz : r5.x);			// partial precision
      r4.xyz = r1.xyz - IN.texcoord_6.xyz;
    ...
    if_lt 9, r2.w
      ...
      r1.xyz = (r6.x == 0.0 ? LightData[18].xyz : r5.x);			// partial precision
