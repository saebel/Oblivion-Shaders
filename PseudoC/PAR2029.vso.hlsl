...
//
    ...
    OUT.texcoord_6.x = dot(r3.xyz, r1.xyz);
    r4.xyz = (IN.blendweight.z * r0.xyz) + r2.xyz;
    ...
    r0.xyz = (r1.w * r0.xyz) + r4.xyz;
    r3.xyz = (r1.w * r2.xyz) + r3.xyz;
    r2.xyz = normalize(r0.xyz);
    r0.xyz = normalize(r3.xyz);
    OUT.texcoord_6.y = dot(r2.xyz, r1.xyz);
    OUT.texcoord_6.z = dot(r0.xyz, r1.xyz);
