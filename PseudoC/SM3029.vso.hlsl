...
//
    ...
    mova a0, r1
    r1.w = (input_5.x * const_2.z.x) + (input_5.y * const_2.z.y) + (input_5.z * const_2.z.z);
    ...
    r0.w = const_2.y;
    output_2.x = (r2.w * r0.w) - VOffset.x;
    r1.z = (r3.x * r2.x) + (r3.y * r2.y) + (r3.z * r2.z);
    r0.w = const_2.z;
    ...
    r1.xyz = norm(r5);
    r2.y = (r1.x * r4.x) + (r1.y * r4.y) + (r1.z * r4.z);
    ...
    r0.z = 1.0 / FogParam.y;
    output_3.xyz = r2 * r0.y;
    r0.w = sat(r0.w * r0.z);
    r0.z = const_2.z - r0.w;
    r0.y = const_3.y;
    r0.w = (r0.y < FogParam.z ? 1.0 : 0.0);
    output_0.xyz = r1;
    output_4.w = r0.z * r0.w;
    output_1.xy = input_4;
