...
//
    ...
    r0.w = r0.z * r0.w;
    r0.z = r0.w * r0.w;
    r0.y = (r0.z * const_0.y) + const_0.z;
    r0.y = (r0.z * r0.y) + const_0.w;
    r0.y = (r0.z * r0.y) + const_1.x;
    r0.z = (r0.z * r0.y) + const_1.y;
    r0.y = r0.w * r0.z;
    r0.w = (r0.y * const_1.z) + const_1.w;
    ...
    offset = r1;
    r1.w = dot(IN.blendweight, const_2.z);
    ...
    r3.x = dot(const_14[offset.w], r0);
    r3.y = dot(const_15[offset.w], r0);
    r3.z = dot(const_16[offset.w], r0);
    r0.x = dot(const_14[offset.y], IN.normal);
    r0.y = dot(const_15[offset.y], IN.normal);
    r0.z = dot(const_16[offset.y], IN.normal);
    r1.xyz = r0 * IN.blendweight.y;
    r0.x = dot(const_14[offset.x], IN.normal);
    r0.y = dot(const_15[offset.x], IN.normal);
    r0.z = dot(const_16[offset.x], IN.normal);
    r1.xyz = (IN.blendweight.x * r0) + r1;
    r0.x = dot(const_14[offset.z], IN.normal);
    r0.y = dot(const_15[offset.z], IN.normal);
    r0.z = dot(const_16[offset.z], IN.normal);
    ...
    r1.z = dot(r3, r2);
    r0.w = const_2.z;
    r1.z = (r1.z < const_2.z ? 1.0 : 0.0);
    OUT.position.w = dot(SkinModelViewProj[3], r0);
    r1.xyz = r2 * r1.z;
    r4.xyz = (const_1.z * r1) + r2;
    ...
    r1.x = dot(const_14[offset.w], IN.tangent);
    r1.y = dot(const_15[offset.w], IN.tangent);
    r1.z = dot(const_16[offset.w], IN.tangent);
    r6.xyz = (r1.w * r1) + r2;
    ...
    r2.x = dot(const_14[offset.w], IN.binormal);
    r2.y = dot(const_15[offset.w], IN.binormal);
    r2.z = dot(const_16[offset.w], IN.binormal);
    r1.xyz = normalize(r6);
    r5.xyz = (r1.w * r2) + r5;
    r2.x = dot(r1, r4);
    r1.xyz = normalize(r5);
    ...
    r0.z = dot(r2, r2);	// normalize + length
    r0.w = 1.0 / sqrt(r0.w);
    r0.y = 1.0 / sqrt(r0.z);
    r0.w = 1.0 / r0.w;
    r0.w = FogParam.x - r0.w;
    r0.z = 1.0 / FogParam.y;
    OUT.texcoord_3.xyz = r2 * r0.y;
