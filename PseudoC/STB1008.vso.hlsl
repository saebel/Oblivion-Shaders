...
//
    ...
    texcoord_3.x = (input_3.x * r2.x) + (input_3.y * r2.y) + (input_3.z * r2.z);
    texcoord_3.y = (input_4.x * r2.x) + (input_4.y * r2.y) + (input_4.z * r2.z);
    texcoord_3.z = (input_1.x * r2.x) + (input_1.y * r2.y) + (input_1.z * r2.z);
    r2.xyz = input_1;
    r0.x = (input_3.x * r2.x) + (input_3.y * r2.y) + (input_3.z * r2.z);
    r0.y = (input_4.x * r2.x) + (input_4.y * r2.y) + (input_4.z * r2.z);
    r0.z = (input_1.x * input_1.x) + (input_1.y * input_1.y) + (input_1.z * input_1.z);
    r0.w = 1.0 / LightPosition.w;
    color_0.xyz = (const_4.x * r0) + const_4.x;
    r0.xyz = r1 * r0.w;
