...
//
    ...
    sampler2D ShadowMap;
    sampler2D ShadowMaskMap;
    r1.xyzw = tex2D(ShadowMap, IN.texcoord_2);			// partial precision
    r0.xyzw = tex2D(ShadowMaskMap, IN.texcoord_3);			// partial precision
    r1.xyz = r1.xyz + -1;			// partial precision
    r0.xyz = r0.x * r1.xyz;			// partial precision
    r1.xyz = (IN.texcoord_3.z * r0) + 1;			// partial precision
    ...
    r1.x = 0.4;
    r1.xyz = r1.x * PointLightColor.rgb;			// partial precision
    r1.xyz = (r1.w * r1.xyz) + r3.xyz;			// partial precision
