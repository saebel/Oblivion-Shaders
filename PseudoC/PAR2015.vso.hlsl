...
//
    ...
    r2.xyz = (r1.w * r1) + r2;
    r7.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r1.xyz = norm(r2);
    r1.w = 1.0 / sqrt(r7.x);
    r6.z = (r1.x * LightDirection[0].x) + (r1.y * LightDirection[0].y) + (r1.z * LightDirection[0].z);
    r2.xyz = (r1.w * r5) + LightDirection[0];
    r7.xyz = norm(r2);
    r2.x = (r4.x * r7.x) + (r4.y * r7.y) + (r4.z * r7.z);
    r2.y = (r3.x * r7.x) + (r3.y * r7.y) + (r3.z * r7.z);
    r2.z = (r1.x * r7.x) + (r1.y * r7.y) + (r1.z * r7.z);
    r8.xyz = norm(r6);
    texcoord_1.xyz = r8;
    r6.xyz = r5 * r1.w;
    r8.xyz = norm(r2);
    texcoord_3.xyz = r8;
    r5.x = (r4.x * r6.x) + (r4.y * r6.y) + (r4.z * r6.z);
    r5.y = (r3.x * r6.x) + (r3.y * r6.y) + (r3.z * r6.z);
    r5.z = (r1.x * r6.x) + (r1.y * r6.y) + (r1.z * r6.z);
    r7.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r2.xyz = LightPosition[1] - r0;
    r1.w = 1.0 / sqrt(r7.x);
    r7.x = (r2.x * r2.x) + (r2.y * r2.y) + (r2.z * r2.z);
    texcoord_6.xyz = r5 * r1.w;
    r1.w = 1.0 / sqrt(r7.x);
    r5.xyz = r2 * r1.w;
    r6.xyz = (r1.w * r2) + r6;
