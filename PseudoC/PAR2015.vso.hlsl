...
//
    ...
    OUT.texcoord_6.xyz = r5.xyz * r1.w;
    r1.w = 1.0 / sqrt(r7.x);
    r5.xyz = r2.xyz * r1.w;
    r6.xyz = (r1.w * r2.xyz) + r6.xyz;
    ...
    OUT.texcoord_5.xyz = (0.5 * r5.xyz) + 0.5;
