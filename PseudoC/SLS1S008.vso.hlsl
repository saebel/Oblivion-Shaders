...
//
    ...
    r7.xyz = r3 * IN.blendweight.y;
    offset.x = r0.x;
    r3.x = dot(Bones[0 + offset.x], IN.normal);
    r3.y = dot(Bones[1 + offset.x], IN.normal);
    r3.z = dot(Bones[2 + offset.x], IN.normal);
    r3.xyz = (IN.blendweight.x * r3) + r7;
    offset.x = r0.z;
    ...
    r2.xyz = (r2.w * r2) + r6;
    r0.xyz = (r2.w * r0) + r3;
    r6.x = dot(r2, r2);	// normalize + length
    r3.x = dot(r0, r0);	// normalize + length
    r1.w = 1.0 / sqrt(r6.x);
    r0.w = 1.0 / sqrt(r3.x);
    r3.xyz = r2 * r1.w;
    r2.xyz = r0 * r0.w;
    OUT.texcoord_3.y = dot(r3, r5);
    OUT.texcoord_3.z = dot(r2, r5);
    r0.x = dot(r4, r2);
    r0.y = dot(r3, r2);
    r0.z = dot(r2, r2);	// normalize + length
    r0.w = 1.0 / LightPosition[0].w;
    OUT.color_0.rgb = (const_0.w * r0) + const_0.w;
    r0.xyz = r1 * r0.w;
