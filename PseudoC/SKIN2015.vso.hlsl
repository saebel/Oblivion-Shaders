...
//
    ...
    r5.xyz = norm(r1);
    r1.x = (r5.x * LightDirection[0].x) + (r5.y * LightDirection[0].y) + (r5.z * LightDirection[0].z);
    ...
    r4.xyz = norm(r6);
    r3.xyz = (r1.w * r2) + r3;
    r1.y = (r4.x * LightDirection[0].x) + (r4.y * LightDirection[0].y) + (r4.z * LightDirection[0].z);
    r2.xyz = norm(r3);
    r1.z = (r2.x * LightDirection[0].x) + (r2.y * LightDirection[0].y) + (r2.z * LightDirection[0].z);
    r3.xyz = EyePosition - r0;
    r6.xyz = norm(r3);
    r3.x = (r5.x * r6.x) + (r5.y * r6.y) + (r5.z * r6.z);
    r3.y = (r4.x * r6.x) + (r4.y * r6.y) + (r4.z * r6.z);
    r3.z = (r2.x * r6.x) + (r2.y * r6.y) + (r2.z * r6.z);
    r6.xyz = norm(r1);
    texcoord_1.xyz = r6;
    r1.x = (r3.x * r3.x) + (r3.y * r3.y) + (r3.z * r3.z);
    r1.w = 1.0 / sqrt(r1.x);
    r1.xyz = LightPosition[1] - r0;
    texcoord_7.xyz = r3 * r1.w;
    r3.xyz = norm(r1);
    ...
    texcoord_4.xyz = (const_0.w * r3) + const_0.w;
    r3.xyz = norm(r1);
    texcoord_3.x = (r5.x * r3.x) + (r5.y * r3.y) + (r5.z * r3.z);
    texcoord_3.y = (r4.x * r3.x) + (r4.y * r3.y) + (r4.z * r3.z);
    texcoord_3.z = (r2.x * r3.x) + (r2.y * r3.y) + (r2.z * r3.z);
    ...
    texcoord_5.xyz = (const_0.w * r1) + const_0.w;
