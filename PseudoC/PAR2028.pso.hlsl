...
//
    ...
    r3.xyz = r3.xyz - 0.5;
    r6.xyz = 2 * r3.xyz;			// partial precision
    r3.xyz = normalize(r6.xyz);			// partial precision
    r6.xyz = normalize(IN.texcoord_4.xyz);			// partial precision
    ...
    r5.xyz = saturate(r1.w * r3.xyz);			// partial precision
