...
//
    ...
    r2.w = pow(abs(r4.x), Toggles.z);			// partial precision
    r6.x = dot(r3.xyz, IN.texcoord_1.xyz);			// partial precision
    r3.w = r3.w * r2.w;			// partial precision
    r4.w = r6.x - -0.5;			// partial precision
    r2.w = max(r4.w, 0);			// partial precision
    r2.w = r3.w * r2.w;			// partial precision
    r3.xyz = r0.w * PSLightColor[1].rgb;			// partial precision
    r0.w = 0.2 - r6.x;			// partial precision
    r5.xyz = saturate(r1.w * r3.xyz);			// partial precision
    r0.w = (r0.w >= 0.0 ? r2.w : r3.w);			// partial precision
    r4.xyz = saturate(r0.w * PSLightColor[0].rgb);			// partial precision
    r2.xyz = r2.xyz - 1;			// partial precision
    r3.xyz = (r1.x * r2.xyz) - -1;			// partial precision
