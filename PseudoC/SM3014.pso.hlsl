...
//
    ...
    if_lt -const_2.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[03] : r2.x)
      r0 = (r1.y == 0.0 ? LightData[04] : r0)
      r0 = (r1.z == 0.0 ? LightData[05] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r2.z = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[02] : r2.x)			// partial precision
      r1.x = 1.0 / r2.z;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt const_4.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[05] : r2.x)
      r0 = (r1.y == 0.0 ? LightData[06] : r0)
      r0 = (r1.z == 0.0 ? LightData[07] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r2.z = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[04] : r2.x)			// partial precision
      r1.x = 1.0 / r2.z;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_7.z, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[07] : r2.x)
      r0 = (r1.y == 0.0 ? LightData[08] : r0)
      r0 = (r1.z == 0.0 ? LightData[09] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r2.z = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[06] : r2.x)			// partial precision
      r1.x = 1.0 / r2.z;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
    ...
    if_lt -const_7.w, r2.w
      ...
      r0 = (r1.x == 0.0 ? LightData[09] : r2.x)
      r0 = (r1.y == 0.0 ? LightData[10] : r0)
      r0 = (r1.z == 0.0 ? LightData[11] : r0)
      r8.xyz = r0 - input_5;
      r0.z = (r8.x * r8.x) + (r8.y * r8.y) + (r8.z * r8.z);
      r2.z = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[08] : r2.x)			// partial precision
      r1.x = 1.0 / r2.z;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = (r7.x * r8.x) + (r7.y * r8.y) + (r7.z * r8.z);
      r9.y = (r6.x * r8.x) + (r6.y * r8.y) + (r6.z * r8.z);
