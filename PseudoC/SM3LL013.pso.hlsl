...
//
    ...
    r13.x = 2 * r0.w;
    r13.yz = r13.x + const_20.xx;
    r2.xyz = r13.x + const_20.zxy;
    r14.xyz = (r2 >= 0.0 ? -r13.xyz : r2.xyz);
    r2.xyz = (r14.x <= 0.0 ? r6.y : LightData[1].xyz);			// partial precision
    r2.w = 4;			// partial precision
    r2.w = r2.w - ToggleNumLights.x;			// partial precision
    r2.xyz = (r14.y <= 0.0 ? r2.xyz : LightData[2].xyz);			// partial precision
    ...
    r2.xyz = (r13.x == 0.0 ? LightData[3].xyz : r6.y);			// partial precision
    r2.xyz = (r13.y == 0.0 ? LightData[4].xyz : r2.xyz);			// partial precision
    ...
    r2.xyz = (r13.x == 0.0 ? LightData[5].xyz : r6.y);			// partial precision
    r2.xyz = (r13.y == 0.0 ? LightData[6].xyz : r2.xyz);			// partial precision
    ...
    if_lt 3, r4.w
      ...
      r0.xyz = (r3.x == 0.0 ? LightData[6].xyz : r6.y);			// partial precision
