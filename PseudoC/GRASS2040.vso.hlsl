...
//
    ...
    r2.w = (r1.w * const_13.x) + const_13.y;
    ...
    r2.w = max(r2.w, const_7.x);
    r2.xy = r2 * r3;
    r2.w = min(r2.w, const_8.y);
    r2.xy = max(r2, const_7.x);
    OUT.color_0.a = const_8.y - r2.w;
    r2.xy = min(r2, const_8.y);
    OUT.position = r1;
    r1.w = const_8.y - r2.y;
    ...
    OUT.texcoord_4 = const_7.x;
    OUT.texcoord_5.xyz = const_7.x;
