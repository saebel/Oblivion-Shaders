...
//
    ...
    r0.xyz = r0 + const_31.x;			// partial precision
    ...
    if_ne r0.w, -r0.w
      ...
      r0.w = max(r1.w, const_31.y);			// partial precision
      r0.x = dot(r4, LightData[1]);			// partial precision
      r0.w = const_31.z - r0.w;			// partial precision
      ...
      r2.xyz = (const_31.w * r0) + r0.w;			// partial precision
      r0.xyz = max(r2, const_31.y);			// partial precision
    ...
    r0.w = (r0.x >= 0.0 ? const_31.z : const_31.y);
    r0.y = r0.x - floor(r0.x);			// partial precision
    r0.z = (r0.y <= 0.0 ? const_31.z : const_31.y);
    r0.y = r0.x - r0.y;			// partial precision
    r1.w = (r0.w * r0.z) + r0.y;
    r0.w = (r1.w <= 0.0 ? const_31.z : const_31.y);
    if_ne r0.w, -r0.w
      r3.x = r2.w + r2.w;
      r3.yz = r3.x + const_2;
      ...
      r9.xyz = (r0 >= 0.0 ? -r3 : r0);
      r3.w = max(r0.w, const_31.y);			// partial precision
      r0 = (r9.x <= 0.0 ? r11.y : LightData[1]);
      r3.w = const_31.z - r3.w;			// partial precision
      ...
      r3.w = max(r6.w, const_31.y);			// partial precision
      ...
      r0.w = (r0.w * -r0.w) + const_31.z;			// partial precision
      r3.xyz = r0 * r0.w;			// partial precision
      r0.xyz = max(r3, const_31.y);			// partial precision
      r2.xyz = r2 + r0;			// partial precision
      r2.w = r2.w + const_31.z;
    endif
    if_lt const_31.z, r1.w
      r0.w = dot(r1, r5);			// partial precision
    ...
    if_lt -const_8.z, r1.w
      ...
      r1.w = max(r0.z, const_31.y);			// partial precision
      r0.z = max(r3.w, const_31.y);			// partial precision
      r1.z = const_31.z - r0.z;			// partial precision
      r1.xy = (const_33.x * r2.w) + const_33.yzzw;
