...
//
    ...
    r0.xyz = norm(r8);
    r7.xyz = (r1.w * r1) + r7;
    r2.y = (r0.x * r6.x) + (r0.y * r6.y) + (r0.z * r6.z);
    r1.xyz = norm(r7);
    r2.z = (r1.x * r6.x) + (r1.y * r6.y) + (r1.z * r6.z);
    r8.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r1.w = 1.0 / sqrt(r8.x);
    r5.xyz = (r1.w * r5) + r6;
    r6.xyz = norm(r2);
    texcoord_1.xyz = r6;
    ...
    texcoord_3.y = (r0.x * r2.x) + (r0.y * r2.y) + (r0.z * r2.z);
    r0.xyz = r3 * r0.w;
