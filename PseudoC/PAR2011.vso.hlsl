...
//
    ...
    r5.y = dot(r6, LightDirection[0]);
    r2.xyz = (r1.w * r2) + r3;
    r3.xyz = normalize(r2);
    r2.xyz = EyePosition - r0;
    r5.z = dot(r3, LightDirection[0]);
    r7.x = dot(r2, r2);	// normalize + length
    r4.x = dot(r5, r5);	// normalize + length
    r1.w = 1.0 / sqrt(r7.x);
    r2.w = 1.0 / sqrt(r4.x);
    r4.xyz = (r1.w * r2) + LightDirection[0];
    OUT.texcoord_1.xyz = r5 * r2.w;
    r5.xyz = normalize(r4);
    r4.xyz = r2 * r1.w;
    r2.x = dot(r1, r5);
    r1.x = dot(r1, r4);
