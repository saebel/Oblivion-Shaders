...
//
    ...
    r5.x = (r1.x * LightDirection[0].x) + (r1.y * LightDirection[0].y) + (r1.z * LightDirection[0].z);
    r2.xyz = (r1.w * r2) + r3;
    r6.xyz = norm(r2);
    ...
    r5.y = (r6.x * LightDirection[0].x) + (r6.y * LightDirection[0].y) + (r6.z * LightDirection[0].z);
    r2.xyz = (r1.w * r2) + r3;
    r3.xyz = norm(r2);
    r2.xyz = EyePosition - r0;
    r5.z = (r3.x * LightDirection[0].x) + (r3.y * LightDirection[0].y) + (r3.z * LightDirection[0].z);
    r7.x = (r2.x * r2.x) + (r2.y * r2.y) + (r2.z * r2.z);
    r4.x = (r5.x * r5.x) + (r5.y * r5.y) + (r5.z * r5.z);
    r1.w = 1.0 / sqrt(r7.x);
    r2.w = 1.0 / sqrt(r4.x);
    r4.xyz = (r1.w * r2) + LightDirection[0];
    texcoord_1.xyz = r5 * r2.w;
    r5.xyz = norm(r4);
    r4.xyz = r2 * r1.w;
    r2.x = (r1.x * r5.x) + (r1.y * r5.y) + (r1.z * r5.z);
    r1.x = (r1.x * r4.x) + (r1.y * r4.y) + (r1.z * r4.z);
    r2.y = (r6.x * r5.x) + (r6.y * r5.y) + (r6.z * r5.z);
    r1.y = (r6.x * r4.x) + (r6.y * r4.y) + (r6.z * r4.z);
    r2.z = (r3.x * r5.x) + (r3.y * r5.y) + (r3.z * r5.z);
    r1.z = (r3.x * r4.x) + (r3.y * r4.y) + (r3.z * r4.z);
    r3.x = (r2.x * r2.x) + (r2.y * r2.y) + (r2.z * r2.z);
    r1.w = 1.0 / sqrt(r3.x);
    texcoord_3.xyz = r2 * r1.w;
    r5.xyz = norm(r1);
    texcoord_6.xyz = r5;
