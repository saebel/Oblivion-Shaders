...
//
    ...
    sampler2D NormalMap;
    r9.xy = const_4.xy;
    r0.w = r9.y - ToggleNumLights.x;			// partial precision
    r3.z = min(ToggleNumLights.y, r0.w);			// partial precision
    r1.w = frac(r3.z);			// partial precision
    r2.w = (r3.z >= 0.0 ? 0 : 1);
    r3.w = (r1.w <= 0.0 ? 0 : 1);
    ...
    if_lt 1, r3.w
      ...
      r1.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r1.z);
      r1.xyz = (r3.x == 0.0 ? LightData[2].xyz : r2.w);			// partial precision
      r3.x = 1.0 / r4.w;
      r1.w = 1.0 / r1.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 2, r3.w
      ...
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[4].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 3, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[6].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 4, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[8].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 5, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[10].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 6, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[12].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 7, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[14].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 8, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[16].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 9, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[18].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 10, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[20].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 11, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[22].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 12, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[24].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
    ...
    if_lt 13, r3.w
      ...
      r0.z = dot(r7.xyz, r7.xyz);	// normalize + length
      r4.w = 1.0 / sqrt(r0.z);
      r0.xyz = (r1.x == 0.0 ? LightData[26].xyz : r2.w);			// partial precision
      r1.x = 1.0 / r4.w;
      r0.w = 1.0 / r0.w;			// partial precision
      r8.x = dot(r6.xyz, r7.xyz);
      r8.y = dot(r5.xyz, r7.xyz);
