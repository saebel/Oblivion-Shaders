...
//
    ...
    r4.x = saturate(dot(r0.xyz, r4.xyz));			// partial precision
    ...
    r0.xyz = r4.x * PSLightColor[1].rgb;			// partial precision
    r0.xyz = r1.w * r0.xyz;			// partial precision
    r2.xyz = (r3.x * PSLightColor[0].rgb) + r0.xyz;			// partial precision
