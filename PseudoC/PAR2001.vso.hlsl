...
//
//   vsa shaderdump19/PAR2001.vso /Fcshaderdump19/PAR2001.vso.dis
//
//
// Parameters:
//
...
//
    ...
    r4.x = (r1.x * LightDirection.x) + (r1.y * LightDirection.y) + (r1.z * LightDirection.z);
    r6.xyz = (input_6.z * r2) + r3;
    ...
    r5.xyz = norm(r3);
    r3.xyz = norm(r2);
    r4.y = (r5.x * LightDirection.x) + (r5.y * LightDirection.y) + (r5.z * LightDirection.z);
    r4.z = (r3.x * LightDirection.x) + (r3.y * LightDirection.y) + (r3.z * LightDirection.z);
    ...
    r2.y = (r5.x * r4.x) + (r5.y * r4.y) + (r5.z * r4.z);
