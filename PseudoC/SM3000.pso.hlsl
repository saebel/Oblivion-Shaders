...
//
    ...
    if_lt 3, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[6].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[7].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[8].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 4, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[8].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[9].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[10].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 5, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[10].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[11].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[12].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 6, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[12].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[13].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[14].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 7, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[14].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[15].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[16].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 8, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[16].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[17].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[18].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 9, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[18].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[19].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[20].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 10, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[20].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[21].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[22].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 11, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[22].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[23].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[24].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 12, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[24].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[25].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[26].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 13, r2.w
      ...
      r0.z = dot(r8.xyz, r8.xyz);	// normalize + length
      r2.x = 1.0 / sqrt(r0.z);
      r0.xyz = (r7.x == 0.0 ? LightData[26].xyz : r2.y);			// partial precision
      r2.x = 1.0 / r2.x;
      r0.w = 1.0 / r0.w;			// partial precision
      r9.x = dot(r4.xyz, r8.xyz);
      r9.y = dot(r6.xyz, r8.xyz);
      ...
      r0.w = dot(r3.xyz, r8.xyz);			// partial precision
      r2.x = 1.0 - (r2.x * r2.x);			// partial precision
      r0.xyz = (r7.y == 0.0 ? LightData[27].xyz : r0.xyz);			// partial precision
      r2.x = r0.w * r2.x;			// partial precision
      r0.xyz = (r7.z == 0.0 ? LightData[28].xyz : r0.xyz);			// partial precision
      r0.w = max(r2.x, 0);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
      r1.w = r1.w + 1;
    endif
    if_lt 14, r2.w
      ...
      r1.w = r0.w * r0.z;			// partial precision
      r0.xyz = (r3.x == 0.0 ? LightData[28].xyz : r2.y);			// partial precision
      r0.w = max(r1.w, 0);			// partial precision
      r0.xyz = (r3.y == 0.0 ? LightData[29].xyz : r0.xyz);			// partial precision
      r1.xyz = (r0.w * r0.xyz) + r1.xyz;			// partial precision
    endif
    r0.z = r2.z - ToggleADTS.x;			// partial precision
    r0.w = ToggleADTS.x;			// partial precision
