...
//
    ...
    r2.y = dot(Bones[1 + offset.x], IN.tangent);
    r2.z = dot(Bones[2 + offset.x], IN.tangent);
    r4.xyz = (IN.blendweight.x * r2) + r3;
    offset.x = r0.z;
    r3.x = dot(Bones[0 + offset.x], IN.tangent);
    r3.y = dot(Bones[1 + offset.x], IN.tangent);
    r3.z = dot(Bones[2 + offset.x], IN.tangent);
    r2.xyz = EyePosition - r1;
    r3.xyz = (IN.blendweight.z * r3) + r4;
    offset.x = r0.w;
    ...
    r2.xyz = (r1.w * r2) + LightDirection[0];
    r1.w = 1.0 / sqrt(r3.x);
    ...
    r1.y = dot(r3, r2);
    r1.z = dot(r0, r2);
    OUT.texcoord_1.xyz = (const_0.w * r1) + const_0.w;
