...
//
    ...
    r0.x = dot(Bones[0 + offset.w].xyz, IN.binormal.xyz);
    r0.y = dot(Bones[1 + offset.w].xyz, IN.binormal.xyz);
    r0.z = dot(Bones[2 + offset.w].xyz, IN.binormal.xyz);
    r5.x = dot(Bones[0 + offset.y].xyz, IN.normal.xyz);
    r5.y = dot(Bones[1 + offset.y].xyz, IN.normal.xyz);
    r5.z = dot(Bones[2 + offset.y].xyz, IN.normal.xyz);
    r7.xyz = r5.xyz * IN.blendweight.y;
    r5.x = dot(Bones[0 + offset.x].xyz, IN.normal.xyz);
    r5.y = dot(Bones[1 + offset.x].xyz, IN.normal.xyz);
    r5.z = dot(Bones[2 + offset.x].xyz, IN.normal.xyz);
    r7.xyz = (IN.blendweight.x * r5.xyz) + r7.xyz;
    r5.x = dot(Bones[0 + offset.z].xyz, IN.normal.xyz);
    r5.y = dot(Bones[1 + offset.z].xyz, IN.normal.xyz);
    r5.z = dot(Bones[2 + offset.z].xyz, IN.normal.xyz);
    r7.xyz = (IN.blendweight.z * r5.xyz) + r7.xyz;
    r5.x = dot(Bones[0 + offset.w].xyz, IN.normal.xyz);
    r5.y = dot(Bones[1 + offset.w].xyz, IN.normal.xyz);
    r5.z = dot(Bones[2 + offset.w].xyz, IN.normal.xyz);
