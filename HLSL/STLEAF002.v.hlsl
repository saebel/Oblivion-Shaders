...
#define	PI	3.14159274
    ...
    irock = (IN.blendindices.z * const_8.x) + RockParams.y;
    irstl = (IN.blendindices.z * const_8.x) + RustleParams.y;

    irock = (irock * const_8.y) + const_8.z;
    irstl = (irstl * const_8.y) + const_8.z;
    ...
    ir2 = (ir1 * ir0) + const_8.w;
    is1 = (is0 * is1) + const_8.w;
    ...
    rr0 = frac((ir2 * const_9.x) + const_9.yzzw);
    rr1 = frac((is0 * const_9.x) + const_9.yzzw);
    ...
    irm = (irm * rr0) + const_8.w;
    ism = (ism * rr1) + const_8.w;
    ...
    r1 = IN.blendindices.w * LeafBase[offset];
