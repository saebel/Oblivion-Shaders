...
//
//   fxc /Tps_2_b HLSL/WATERHMAP000.p.hlsl /FcHLSL/WATERHMAP000.p.asm
//
//
// Parameters:
//
...
//
    ...
    frc r2.w, r2.w
    mad r3.w, r2.w, c1.z, c1.w
    sincos r2.xy, r3.w, c3, c4
    mul r3.w, r0.y, r2.y
    mul r2.w, r0.y, r2.x
    mad r1.w, r1.w, c1.x, c1.y
    frc r1.w, r1.w
    mad r2.x, r0.x, r2.x, -r3.w
    mad r3.w, r1.w, c1.z, c1.w
    sincos r1.xy, r3.w, c3, c4
    mad r2.y, r0.x, r2.y, r2.w
    mul r1.w, r0.w, r1.y
    mad r0.x, r0.z, r1.x, r1.w
    mul r0.w, r0.w, r1.x
    mad r0.y, r0.z, r1.y, -r0.w
    add r0.xy, r2, r0
    mov r0.z, c2.x
    mov r0.w, c2.y
    mov oC0, r0
