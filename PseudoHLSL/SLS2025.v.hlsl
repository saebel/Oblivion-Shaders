...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    m25.xy = mul(float2x4(ShadowProj[0].xyzw, ShadowProj[1].xyzw), IN.position.xyzw);
    ...
    OUT.texcoord_5.xyz = compress(lit2.xyz / LightPosition[2].w);	// [-1,+1] to [0,1]
    OUT.texcoord_6.xy = ((q4.x * ShadowProjTransform.xy) + m25.xy) / (q4.x * ShadowProjTransform.w);
    OUT.texcoord_6.zw = ((m25.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
