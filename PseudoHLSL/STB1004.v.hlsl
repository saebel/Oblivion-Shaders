...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    OUT.position.xyzw = mul(ModelViewProj, (IN.blendindices.x * (q2.xyzw - IN.position.xyzw)) + IN.position.xyzw);
    OUT.texcoord_0.xy = IN.texcoord_0.xy;
    OUT.texcoord_1.xyz = compress(mul(TanSpaceProj, LightDirection[0].xyz));	// [-1,+1] to [0,1]
