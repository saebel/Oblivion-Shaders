...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r0.xyz = (((Toggles.x <= 0.0 ? (r1.xyz * IN.color_0.rgb) : r1.xyz)) * max(((saturate(r4.x) * PSLightColor[0].rgb) + (r1.w * (saturate(r5.x) * PSLightColor[1].rgb))) + ((r0.xyz * EmittanceColor.rgb) + AmbientColor.rgb), 0)) + saturate(r1.w * (r0.w * PSLightColor[1].rgb)) + saturate((((0.2 - r4.x) >= 0.0 ? r3.w : (r3.w * max(r4.x + 0.5, 0)))) * PSLightColor[0].rgb);			// partial precision
