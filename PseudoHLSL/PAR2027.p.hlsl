...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r1.xyzw = tex2D(BaseMap, r1);			// partial precision
    ...
    r5.xyz = r2.xyz + r2.xyz;			// partial precision
    r2.xyz = normalize(r5);			// partial precision
    r5.xyz = normalize(IN.texcoord_4);			// partial precision
    ...
    r3.xyz = saturate(r1.w * r2);			// partial precision
