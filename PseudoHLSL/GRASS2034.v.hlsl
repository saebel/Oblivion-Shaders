...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r1.y = -r1.w;
    r3.xyz = (r2.w * ScaleMask.xyz) + r1.z;
    r1.z = 0;
    r3.xyz = r3.xyz * IN.position.xyz;
    r4.xyz = (dot(r1.xyz, r3.xyz) * ((r5.yzx * r0.zxy) - (r0.yzx * r5.zxy))) + (r5.xyz * dot(r1.wxz, r3.xyz));
