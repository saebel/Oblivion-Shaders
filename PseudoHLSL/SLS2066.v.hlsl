...
//
//   vsa shaderdump19/SLS2066.vso /Fcshaderdump19/SLS2066.vso.dis
//
//
// Parameters:
//
...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    lit3.x = saturate(1 - (length(lit0.xyz) / LightPosition[0].w));
    OUT.texcoord_0.xy = IN.texcoord_0.xy;
    OUT.texcoord_1.xy = IN.texcoord_0.xy;
    OUT.texcoord_2.w = lit3.x;
    OUT.texcoord_2.xyz = lit3.x * IN.color_0.rgb;
