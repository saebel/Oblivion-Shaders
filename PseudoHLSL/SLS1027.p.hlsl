...
//
//   vsa shaderdump19/SLS1027.pso /Fcshaderdump19/SLS1027.pso.dis
//
//
// Parameters:
...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r0.xyz = saturate(saturate(dot(2 * (r2.xyz - 0.5), 2 * (IN.texcoord_3.xyz - 0.5))) * PSLightColor[0]) + (r1.xyz + AmbientColor.rgb)) * (r0.xyz * IN.color_0.rgb);	// [0,1] to [-1,+1]
