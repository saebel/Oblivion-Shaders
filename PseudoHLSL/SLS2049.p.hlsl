...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r0.xyz = (((r1.x * (r2.x - 1)) + 1) * (r0.x * PSLightColor[0].rgb)) + AmbientColor.rgb;			// partial precision
    ...
    r0.w = saturate(((r1.x * 2) + r3.w) - 1);			// partial precision
    r0.xyz = (r3.xyz * r0.xyz) * IN.texcoord_2.xyz;			// partial precision
