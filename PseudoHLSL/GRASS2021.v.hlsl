...
#define	sqr(v)			((v) * (v))
    ...
    r2.w = shade(DiffuseDir.xyz, r1.xyz);
    q4.xyz = min(r2.w, 1) * ((frac(InstanceData[0 + IN.texcoord_1.x].w) * IN.color_0.rgb) * DiffuseColor.rgb);
    r1.xy = const_3.xy;
    r3.xyz = (((r1.x * InstanceData[0 + IN.texcoord_1.x].w) * ScaleMask.xyz) + r1.y) * IN.position.xyz;
    r4.y = dot(r0.wxz, r3.xyz);
    r4.x = dot(r0.xyz, r3.xyz);
    r0.z = r3.z;
    r0.xy = (((sin(fracr((q0.x / 128) + WindData.w)) * WindData.z) * sqr(IN.color_0.a)) * WindData.xy) + r4.xy;
    ...
    OUT.texcoord_5.xyz = q4.xyz * AddlParams.x;
