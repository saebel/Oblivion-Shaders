...
#define	PI	3.14159274
    ...
    r1.w = r1.w * r1.w;
    r0.xy = (PI * 2 * frac((((((r1.w * ((r1.w * ((r1.w * ((r1.w * ((r1.w * -2.52398507e-007) + 2.47609005e-005)) - 0.00138883968)) + (1.0 / 24))) - 0.5)) + 1) * RockParams.z) * RockParams.x) * (1.0 / (PI * 2))) + const_12.yz)) - PI;
    r0.xy = r0.xy * r0.xy;
    r1.xy = (-2.52398507e-007 * r0.xy) + 2.47609005e-005;
    r2.xy = (r1 * r0.xy) - 0.00138883968;
    r2.xy = (r2 * r0.xy) + (1.0 / 24);
    r2.xy = (r2 * r0.xy) - 0.5;
    r3.xy = (((((r0.w * ((r0.w * ((r0.w * ((r0.w * ((r0.w * -2.52398507e-007) + 2.47609005e-005)) - 0.00138883968)) + (1.0 / 24))) - 0.5)) + 1) * RustleParams.z) * RustleParams.x) * (1.0 / (PI * 2))) + const_12.yz;
