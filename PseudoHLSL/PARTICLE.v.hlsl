...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    r0.xyz = ((0.5 * (((r1.w * r0.xyz) + Acceleration.xyz) * (r3.w * r3.w))) + ((r3.w * ((r1.z * r0.xyz) + Velocity.xyz)) + InstanceData[0 + offset.w])) - fVars3.xyz;
    r5.w = 1.0 / fVars0.y;
    r6.w = r3.w * r5.w;
    ...
    OUT.position.xy = ((1.0 / fVars1.w) * (lerp(r1.y, r1.x, ((r3.w * r5.w) - r1.z) * (1.0 / (r1.w - r1.z))) * IN.position.xy)) + r5.xy;
    r1.w = fVars1.x;
    r3.xyz = (fVars1.xyz < r6.w ? 1.0 : 0.0);
    r1.x = r3.x * r1.w;
    r1.z = lerp(fVars1.y, fVars1.x, r3.x);
    r1.xy = lerp((fVars1.z * r4.zwzw) + r4.wz, lerp(fVars1.yzzw, r1.xzzw, r3.y), r3.z);
    r0.xyzw = lerp(lerp(const_13.zzzw, lerp(Color3.rgba, ((r3.x * (Color2.rgba - Color1.rgba)) + Color1.rgba), r3.y), r3.z), lerp(Color3.rgba, lerp(Color2.rgba, ((r3.x * (Color1.rgba - r4.zzzw)) + const_13.zzzw), r3.y), r3.z), ((r3.w * r5.w) - r1.x) / ((r1.y - r1.x)));
