...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    m22.xy = mul(float2x4(ShadowProj[0].xyzw, ShadowProj[1].xyzw), IN.position.xyzw);
    ...
    OUT.texcoord_7.xy = ((q3.x * ShadowProjTransform.xy) + m22.xy) / (q3.x * ShadowProjTransform.w);
    OUT.texcoord_7.zw = ((m22.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
