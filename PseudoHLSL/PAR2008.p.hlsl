...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r0.xyz = (((Toggles.x <= 0.0 ? (r0.xyz * IN.color_0.rgb) : r0.xyz)) * max((saturate(r3.x) * PSLightColor[0].rgb) + AmbientColor.rgb, 0)) + saturate((((0.2 - r3.x) >= 0.0 ? r2.w : (r2.w * max(r3.x + 0.5, 0)))) * PSLightColor[0].rgb);			// partial precision
