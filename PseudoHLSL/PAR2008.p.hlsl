...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r2.w = r1.w * pow(abs(saturate(dot(r1.xyz, normalize(IN.texcoord_3.xyz)))), Toggles.z);			// partial precision
    r3.x = dot(r1.xyz, IN.texcoord_1.xyz);			// partial precision
    r2.xyz = saturate(((0.2 - r3.x) >= 0.0 ? r2.w : (r2.w * max(r3.x + 0.5, 0))) * PSLightColor[0].rgb);			// partial precision
