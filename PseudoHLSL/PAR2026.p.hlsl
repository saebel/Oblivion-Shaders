...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r3.w = r1.w * pow(abs(saturate(dot(r1.xyz, normalize(IN.texcoord_4.xyz)))), Toggles.z);			// partial precision
    ...
    r2.xyz = saturate(r2.w * ((((0.2 - r4.x) >= 0.0 ? r3.w : (r3.w * max(r4.x + 0.5, 0)))) * PSLightColor[1].rgb));			// partial precision
    r3.xyz = normalize(IN.texcoord_3.xyz);			// partial precision
    r3.w = pow(abs(saturate(dot(r1.xyz, r3.xyz))), Toggles.z);			// partial precision
    r3.x = dot(r1.xyz, IN.texcoord_1.xyz);			// partial precision
    r3.w = r1.w * r3.w;			// partial precision
    r2.xyz = r2.xyz + saturate((((0.2 - r3.x) >= 0.0 ? r3.w : (r3.w * max(r3.x + 0.5, 0)))) * PSLightColor[0].rgb);			// partial precision
    r0.xyz = (((Toggles.x <= 0.0 ? (r0.xyz * IN.color_0.rgb) : r0.xyz)) * max(((saturate(r3.x) * PSLightColor[0].rgb) + (r2.w * (saturate(r4.x) * PSLightColor[1].rgb))) + AmbientColor.rgb, 0)) + r2.xyz;			// partial precision
