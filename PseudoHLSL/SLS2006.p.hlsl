...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    q0.xyz = (0.85 * (shades(normalize(expand(r1.xyz)), IN.texcoord_1.xyz) * PSLightColor[0].rgb)) + AmbientColor.rgb;			// partial precision
    q3.xyz = max(q0.xyz, 0) * q2.xyz;			// partial precision
    q4.xyz = (Toggles.y <= 0.0 ? q3.xyz : ((IN.color_1.a * (IN.color_1.rgb - (q2.xyz * max(q0.xyz, 0)))) + q3.xyz));			// partial precision
