...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r5.xyz = saturate((((0.2 - r0.x) >= 0.0 ? r2.w : (r2.w * max(r0.x + 0.5, 0)))) * PSLightColor[0].rgb);			// partial precision
    ...
    r0.xyz = (((Toggles.x <= 0.0 ? (r0.xyz * IN.color_0.rgb) : r0.xyz)) * max((r4.xyz * (r4.w * PSLightColor[0].rgb)) + ((r1.xyz * EmittanceColor.rgb) + AmbientColor.rgb), 0)) + (r5.xyz * r4.xyz);			// partial precision
