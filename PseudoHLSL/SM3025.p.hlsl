...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r0.y = frac(min(PSNumDecals.x, 8));			// partial precision
    r2.z = (((min(PSNumDecals.x, 8) >= 0.0 ? 1 : 0)) * (r0.y <= 0.0 ? 1 : 0)) + (min(PSNumDecals.x, 8) - r0.y);
    ...
    if_lt 7, r2.z
      ...
      r0.z = saturate(r2.w);			// partial precision
    endif
