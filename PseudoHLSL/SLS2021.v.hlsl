...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    OUT.texcoord_6.xy = ((q0.x * ShadowProjTransform.xy) + m17.xy) / (q0.x * ShadowProjTransform.w);
    OUT.texcoord_6.zw = ((m17.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
