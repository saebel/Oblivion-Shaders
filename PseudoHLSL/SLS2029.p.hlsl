...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r0.xyz = ((((r1.x * (r2.xyz - 1)) + 1) * (saturate(dot(r0.xyz, IN.texcoord_1.xyz)) * PSLightColor[0].rgb)) + (saturate((1 - r4.x) - r3.x) * (saturate(dot(r0.xyz, normalize(IN.texcoord_2.xyz))) * PSLightColor[1].rgb))) + AmbientColor.rgb;			// partial precision
