...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r0.xyz = ((saturate((1 - r3.x) - r2.x) * (saturate(dot(r0.xyz, normalize(IN.texcoord_3.xyz))) * PSLightColor[2].rgb)) + ((((r7.x * (r8.xyz - 1)) + 1) * (saturate(dot(r0.xyz, IN.texcoord_1.xyz)) * PSLightColor[0].rgb)) + (saturate((1 - r5.x) - r4.x) * (saturate(dot(r0.xyz, normalize(IN.texcoord_2.xyz))) * PSLightColor[1].rgb)))) + ((r1.xyz * EmittanceColor.rgb) + AmbientColor.rgb);			// partial precision
