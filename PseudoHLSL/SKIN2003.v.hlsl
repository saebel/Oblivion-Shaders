...
#define	sqr(v)			((v) * (v))
    ...
    m97.xy = mul(float2x4(ShadowProj[0].xyzw, ShadowProj[1].xyzw), r0.xyzw);
    ...
    OUT.texcoord_7.xy = ((q2.x * ShadowProjTransform.xy) + m97.xy) / (q2.x * ShadowProjTransform.w);
    OUT.texcoord_7.zw = ((m97.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
