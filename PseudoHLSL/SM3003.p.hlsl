...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    if (0 != r4.w) {
      ...
      r1.xyz = ((r2.w * (2 * ((IN.color_0.g * (r6.x + HairTint.rgb)) + 0.5))) + (r3.w * 0.7)) * LightData[0].xyz;			// partial precision
      r1.xyz = max(r4.z, 0) * r1.xyz;			// partial precision
