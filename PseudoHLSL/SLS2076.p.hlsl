...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r0.xyzw = tex2D(ShadowMap, saturate(((1.0 / (((r1.w <= 0.0 ? (1 - r1.w) : 1)) * 15)) * 0.01) + r0));
    r1.xyzw = tex2D(ShadowMap, r1.xy);
    r0.w = (PSLightColor[0].a * (saturate((((-0.000195312503 - ((IN.texcoord_1.z / -IN.texcoord_2.w) + r1.x)) >= 0.0 ? 1 : 0)) + (((-0.000195312503 - ((IN.texcoord_1.z / -IN.texcoord_2.w) + r0.x)) >= 0.0 ? 1 : 0))) - 1)) + 1;			// partial precision
