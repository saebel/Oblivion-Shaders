...
#define	sqr(v)			((v) * (v))
    ...
    q7.xyz = normalize((q0.x * q37.xyz) + q36.xyz);
    ...
    m39.xyz = mul(float3x3(q26.xyz, q32.xyz, q7.xyz), LightDirection[0].xyz);
    q19.xyz = (IN.blendweight.z * q18.xyz) + ((IN.blendweight.x * q17.xyz) + (q16.xyz * IN.blendweight.y));
    r0.xyz = (q0.x * q20.xyz) + q19.xyz;
    eye8.xyz = normalize(normalize(EyePosition.xyz - r0.xyz) + LightDirection[0].xyz);
    m147.xy = mul(float2x4(ShadowProj[0].xyzw, ShadowProj[1].xyzw), r0.xyzw);
    OUT.position.xyzw = mul(SkinModelViewProj, r0.xyzw);
    q121.x = dot(ShadowProj[3].xyzw, r0.xyzw);
    OUT.texcoord_0.xy = IN.texcoord_0.xy;
    OUT.texcoord_1.xyz = normalize(m39.xyz);
    OUT.texcoord_3.xyz = mul(float3x3(q26.xyz, q32.xyz, q7.xyz), eye8.xyz);
    OUT.texcoord_6.xy = ((q121.x * ShadowProjTransform.xy) + m147.xy) / (q121.x * ShadowProjTransform.w);
