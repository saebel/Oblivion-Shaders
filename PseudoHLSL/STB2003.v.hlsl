...
#define	compress(v)		(((v) * 0.5) + 0.5)
    ...
    m31.xy = mul(float2x4(ShadowProj[0].xyzw, ShadowProj[1].xyzw), IN.position.xyzw);
    q3.x = dot(ShadowProj[3].xyzw, IN.position.xyzw);
    ...
    OUT.texcoord_6.xy = ((q3.x * ShadowProjTransform.xy) + m31.xy) / (q3.x * ShadowProjTransform.w);
    OUT.texcoord_6.zw = ((m31.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
