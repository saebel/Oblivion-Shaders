...
#define	sqr(v)			((v) * (v))
    ...
    OUT.color_1.a = 1 - saturate((FogParam.x - length(mdl40.xyz)) / FogParam.y);
    OUT.position.w = dot(SkinModelViewProj[3].xyzw, r0.xyzw);
    OUT.position.xyz = mdl40.xyz;
    OUT.texcoord_0.xy = IN.texcoord_0.xy;
    OUT.texcoord_1.xyz = normalize(m41.xyz);
    OUT.texcoord_2.xyz = mul(float3x3(q26.xyz, q32.xyz, q38.xyz), normalize(lit7.xyz));
    OUT.texcoord_4.w = 0.5;
    OUT.texcoord_4.xyz = compress(lit7.xyz / LightPosition[1].w);	// [-1,+1] to [0,1]
    OUT.texcoord_6.xyz = normalize(eye39.xyz);
