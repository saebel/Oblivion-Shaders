...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r5.xyzw = tex2D(NormalMap, r0);			// partial precision
    r5.xyz = r5.xyz + -0.5;
    ...
    r3.xyz = r6.x * PSLightColor[1].rgb;			// partial precision
    ...
    r1.xyz = r4.x * PSLightColor[0].rgb;			// partial precision
    r1.xyz = (r2.xyz * r1.xyz) + r3.xyz;			// partial precision
