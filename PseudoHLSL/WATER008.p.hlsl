...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r3.xyz = saturate(saturate(SunDir.w) * r0) + ((r0.w * r1.xyz) + r2.xyz));
    ...
    r3.w = ((r0.x - 0.2) * -(1.0 / 0.35)) + 1;
    r1.w = (r2.w >= 0.0 ? 0 : ((r0.x - 0.2) >= 0.0 ? 0 : ((r0.x - 0.55) >= 0.0 ? (r4.w * ((r3.w * -(r3.w * r3.w)) + 1)) : r4.w)));
