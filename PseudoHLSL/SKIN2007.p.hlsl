...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r0.xyz = ((saturate((1 - r2.x) - r1.x) * ((max(dot(r7.xyz, normalize(IN.texcoord_3.xyz)), 0) * PSLightColor[2].rgb) + ((r1.w * PSLightColor[2].rgb) * 0.5))) + ((((r5.x * (r6.xyz - 1)) + 1) * ((max(dot(r7.xyz, IN.texcoord_1.xyz), 0) * PSLightColor[0].rgb) + ((r1.w * PSLightColor[0].rgb) * 0.5))) + (saturate((1 - r4.x) - r3.x) * ((max(dot(r7.xyz, normalize(IN.texcoord_2.xyz)), 0) * PSLightColor[1].rgb) + ((r1.w * PSLightColor[1].rgb) * 0.5))))) + AmbientColor.rgb;			// partial precision
