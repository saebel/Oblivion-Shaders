...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r1.xyz = (((r2.x * (r3.xyz - 1)) + 1) * (saturate(dot(normalize(2 * (r4.xyz - 0.5)), IN.texcoord_1.xyz)) * PSLightColor[0].rgb)) + ((r1.xyz * EmittanceColor.rgb) + AmbientColor.rgb);			// partial precision	// [0,1] to [-1,+1]
