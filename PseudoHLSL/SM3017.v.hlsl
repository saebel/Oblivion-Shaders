...
#define	shades(n, l)		saturate(dot(n, l))
    ...
    OUT.texcoord_0.z = ((abs(dot(DecalProjection[0][2].xyz, q36.xyz)) / -256) + 1) * q0.x;
    OUT.texcoord_1.xy = (0.0125000002 * m96.xy) + 0.5;
    OUT.texcoord_1.z = ((abs(dot(DecalProjection[1][2].xyz, q46.xyz)) / -256) + 1) * q1.x;
    OUT.texcoord_2.xy = (0.0125000002 * m99.xy) + 0.5;
    OUT.texcoord_2.z = ((abs(dot(DecalProjection[2][2].xyz, q48.xyz)) / -256) + 1) * q2.x;
    OUT.texcoord_3.xy = (0.0125000002 * m102.xy) + 0.5;
    OUT.texcoord_3.z = ((abs(dot(DecalProjection[3][2].xyz, q50.xyz)) / -256) + 1) * q3.x;
    OUT.texcoord_4.xy = (0.0125000002 * m105.xy) + 0.5;
    OUT.texcoord_4.z = ((abs(dot(DecalProjection[4][2].xyz, q52.xyz)) / -256) + 1) * q4.x;
    OUT.texcoord_5.xy = (0.0125000002 * m108.xy) + 0.5;
    OUT.texcoord_5.z = ((abs(dot(DecalProjection[5][2].xyz, q54.xyz)) / -256) + 1) * q5.x;
    OUT.texcoord_6.xy = (0.0125000002 * m111.xy) + 0.5;
    OUT.texcoord_6.z = ((abs(dot(DecalProjection[6][2].xyz, q56.xyz)) / -256) + 1) * q6.x;
    OUT.texcoord_7.xy = (0.0125000002 * m114.xy) + 0.5;
    OUT.texcoord_7.z = ((abs(dot(DecalProjection[7][2].xyz, q15.xyz)) / -256) + 1) * q7.x;
