...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    OUT.texcoord_0.z = ((abs(dot(const_42.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_42.xyz), 0)), 10) * const_32.x);
    r0.x = const_44.w;
    r0.y = const_45.w;
    r0.z = const_46.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_1.z = ((abs(dot(const_46.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_46.xyz), 0)), 10) * const_33.x);
    r0.x = const_48.w;
    r0.y = const_49.w;
    r0.z = const_50.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_2.z = ((abs(dot(const_50.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_50.xyz), 0)), 10) * const_34.x);
    r0.x = const_52.w;
    r0.y = const_53.w;
    r0.z = const_54.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_3.z = ((abs(dot(const_54.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_54.xyz), 0)), 10) * const_35.x);
    r0.x = const_56.w;
    r0.y = const_57.w;
    r0.z = const_58.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_4.z = ((abs(dot(const_58.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_58.xyz), 0)), 10) * const_36.x);
    r0.x = const_60.w;
    r0.y = const_61.w;
    r0.z = const_62.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_5.z = ((abs(dot(const_62.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_62.xyz), 0)), 10) * const_37.x);
    r0.x = const_64.w;
    r0.y = const_65.w;
    r0.z = const_66.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_6.z = ((abs(dot(const_66.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_66.xyz), 0)), 10) * const_38.x);
    r0.x = const_68.w;
    r0.y = const_69.w;
    r0.z = const_70.w;
    r0.xyz = r0.xyz + IN.position.xyz;
    ...
    OUT.texcoord_7.z = ((abs(dot(const_70.xyz, r0.xyz)) / -256) + 1) * (pow(abs(1 - max(dot(IN.normal.xyz, const_70.xyz), 0)), 10) * const_39.x);
