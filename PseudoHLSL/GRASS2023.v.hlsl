...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    OUT.texcoord_5.xyz = saturate(dot(DiffuseDir.xyz, (IN.normal.z * r0.xyz) + ((dot(r1.xyz, IN.normal.xyz) * r4.xyz) + (r5.xyz * dot(r1.wxz, IN.normal.xyz))))) * ((r2.w * IN.color_0.rgb) * DiffuseColor.rgb) * AddlParams.x;
