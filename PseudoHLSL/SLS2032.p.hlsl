...
PS_OUTPUT main(VS_OUTPUT IN) {
    ...
    r2.xyz = (saturate((1 - r3.x) - r2.x) * (saturate(dot(r0.xyz, normalize(IN.texcoord_3.xyz))) * PSLightColor[2].rgb)) + ((saturate(dot(r0.xyz, IN.texcoord_1.xyz)) * PSLightColor[0].rgb) + r4.xyz);			// partial precision
