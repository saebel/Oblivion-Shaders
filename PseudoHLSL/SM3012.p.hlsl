...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    r1.z = 15 - ToggleNumLights.x;			// partial precision
    ...
    r0.w = (r2.w <= 0.0 ? 1 : 0);
    if_ne 0, r0.w
      r1.yz = (2 * r1.w) + const_1.yz;
      r1.xyz = (r0 >= 0.0 ? -r1.xyz : ((2 * r1.w) + const_1.wyz));
    ...
    if_lt 14, r2.w
      ...
      r0.xyz = (r1.y == 0.0 ? LightData[29].xyz : (r1.x == 0.0 ? LightData[28].xyz : r3.y));			// partial precision
      r2.xyz = (r0.w * r0.xyz) + r2.xyz;			// partial precision
    endif
