...
//
//   vsa shaderdump19/PAR2019.vso /Fcshaderdump19/PAR2019.vso.dis
//
//
// Parameters:
...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    r6.xyz = (IN.blendweight.z * r1.xyz) + r2.xyz;
    ...
    r4.xyz = normalize((r1.w * r2.xyz) + r6.xyz);
    r2.xyz = normalize(r1.xyz);
    r1.xyz = normalize(EyePosition.xyz - r0.xyz);
    r6.x = dot(r5.xyz, r1.xyz);
    r6.y = dot(r4.xyz, r1.xyz);
    r6.z = dot(r2.xyz, r1.xyz);
    r1.xyz = LightPosition[1].xyz - r0.xyz;
    r3.x = dot(r5.xyz, LightDirection[0].xyz);
    r3.y = dot(r4.xyz, LightDirection[0].xyz);
    r3.z = dot(r2.xyz, LightDirection[0].xyz);
    ...
    OUT.texcoord_7.xyz = r6.xyz * (1.0 / length(r6.xyz));
    ...
    OUT.texcoord_6.xy = ((r0.w * ShadowProjTransform.xy) + r2.xy) / ((r0.w * ShadowProjTransform.w));
