...
#define	D3DSINCOSCONST2	-0.020833334, -0.125, 1, 0.5
    ...
    OUT.texcoord_5.xyz = ((r2.xyz * saturate(dot(DiffuseDir.xyz, r0.xyz))) * DiffuseColor.rgb) * AddlParams.x;
    ...
    r0.yz = const_3.yz;
    r3.w = r0.y * InstanceData[0 + offset.w].w;
    r0.y = -r0.w;
    r1.xyz = (r3.w * ScaleMask.xyz) + r0.z;
    r0.z = 0;
