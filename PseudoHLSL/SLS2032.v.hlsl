...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    r3.xyz = normalize(r1);
    r1.x = dot(r3.xyz, LightDirection[0].xyz);
    ...
    r5.xyz = (IN.blendweight.z * r0.xyz) + r2.xyz;
    ...
    r5.xyz = (r1.w * r0.xyz) + r5.xyz;
    r5.xyz = normalize(r1);
    OUT.texcoord_1.xyz = r5.xyz;
    r0.xyz = normalize(r5);
    r6.x = dot(r4.xyz, r4.xyz);	// normalize + length
    r1.w = 1.0 / sqrt(r6.x);
    r1.z = dot(r0.xyz, LightDirection[0].xyz);
    r1.xyz = normalize(r4);
    OUT.texcoord_3.x = dot(r3.xyz, r1.xyz);
    OUT.texcoord_3.y = dot(r2.xyz, r1.xyz);
    OUT.texcoord_3.z = dot(r0.xyz, r1.xyz);
    r4.xyz = (r1.w * r4.xyz) + LightDirection[0].xyz;
