...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    r2.xyz = normalize((r1.w * r1.xyz) + r2.xyz);
    ...
    r1.w = 1.0 / length(r6.xyz);
    r5.xyz = EyePosition.xyz - r0.xyz;
    r2.w = 1.0 / length(r5.xyz);
    r7.xyz = normalize((r2.w * r5.xyz) + LightDirection[0].xyz);
    ...
    r0.xyz = normalize((r1.w * r6.xyz) + r5.xyz);
    OUT.texcoord_5.xyz = (0.5 * (r6.xyz / LightPosition[1].w)) + 0.5;	// [-1,+1] to [0,1]
