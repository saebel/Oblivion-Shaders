...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    r1.xyz = normalize(EyePosition.xyz - IN.position.xyz) + r2.xyz;
    ...
    OUT.color_0.rgb = (saturate(dot(IN.normal.xyz, LightDirection[1].xyz)) * LightColor[1].rgb) + ((saturate(dot(IN.normal.xyz, r0.xyz)) * LightColor[1].rgb) * (r0.w * r0.w));
