...
#define	sqr(v)			((v) * (v))
    ...
    q35.xyz = lerp(r2.xyz, (q46.x * (ShallowColor.rgb - DeepColor.rgb)) + DeepColor.rgb, q12.x);
    q36.xyz = lerp(t50.xyz, (saturate(SunDir.w) * (q45.x * SunColor.rgb)) + q35.xyz, q4.x * VarAmounts.w);
