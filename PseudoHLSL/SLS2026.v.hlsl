...
#define	sqr(v)			((v) * (v))
    ...
    OUT.texcoord_6.xy = ((q128.x * ShadowProjTransform.xy) + m154.xy) / (q128.x * ShadowProjTransform.w);
    OUT.texcoord_6.zw = ((m154.xy - ShadowProjData.xy) / ShadowProjData.w) * float2(1, -1) + float2(0, 1);
